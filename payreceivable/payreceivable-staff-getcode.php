...
if(!empty($_REQUEST['scode']))
	...
	if($payreceivable_row['staff_code']==""){
		echo 1;
		}else{
		echo $payreceivable_row['staff_code'].";".$payreceivable_row['payreceivable_accountdebit'].";".$payreceivable_row['payreceivable_amount'].";".$payreceivable_row['payreceivable_tenor'];
		}
	}
?>