            ...
            <aside class="right-side">                
                ...
                <section class="content">
                    <div class="row"><form action="payable-edit.php" method="post" enctype="multipart/form-data" name="form" id="form">
                        <div class="col-xs-12">
...
<div class="row clearfix">
  ...
  <div class="col-md-10"><select name="payreceivable_accountcredit" class="textbox" id="payreceivable_accountcredit">
    <?
			$global->payreceivable->book->account_parent_special_create(array("payable_liquid","payable_fixed"),$payreceivable_row['payreceivable_accountcredit']);
			?>
    </select></div>
</div>
...
<table class="table table-bordered product_order_buy">
  ...
  $payreceivable_accountdebit=$taxonomi_row['taxonomi_code']." - ".$taxonomi_row['taxonomi_name'];
  ?>
  <tr id="inner<? echo $j; ?>">
  <td class="listnum_payable_get">#</td>
  <td><a href="#" class="link_table payable_get_edit"><div class="payreceivable_accountdebit"><? echo $payreceivable_accountdebit; ?></div><input class="payreceivable_accountdebit_hidden" name="payreceivable_accountdebit_hidden[]" type="hidden" value="<? echo $payreceivable_accountdebit; ?>"/></a></td>
  <td><a href="#" class="link_table payable_get_edit"><div class="payreceivable_amount"><? echo $payreceivable_amount; ?></div><input class="payreceivable_amount_hidden" name="payreceivable_amount_hidden[]" type="hidden" value="<? echo $payreceivable_amount_unf; ?>"/></a></td>
  <td><a href="javascript:;" class="btn btn-danger" onclick="remove_payable_get(this);"> <span class="glyphicon glyphicon-minus" aria-hidden="true"></span> </a></td>
  </tr>
  <?
		}
  ?>
...
<div class="box-body table-responsive">
<form method="post" enctype="multipart/form-data" name="form_payable_edit" id="form_payable_edit"><input name="inner_id_hidden" type="hidden" id="inner_id_hidden" value="" />
<div class="box-header">
