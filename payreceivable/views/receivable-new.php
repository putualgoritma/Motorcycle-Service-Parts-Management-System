            ...
            <aside class="right-side">                
                ...
                <section class="content">
                    <div class="row"><form action="receivable-new.php" method="post" enctype="multipart/form-data" name="form" id="form">
                        <div class="col-xs-12">
...
<div class="row clearfix">
  ...
  <div class="col-md-10 typehead_users"><input name="payreceivable_tenor" type="text" class="textbox" id="payreceivable_tenor" value="1" size="5" required="required">
    kali</div>
</div>
<div class="row clearfix">
