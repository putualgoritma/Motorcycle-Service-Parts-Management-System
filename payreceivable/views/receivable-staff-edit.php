            ...
            <aside class="right-side">                
                ...
                <section class="content">
                    <div class="row"><form action="receivable-staff-edit.php" method="post" enctype="multipart/form-data" name="form" id="form">
                        <div class="col-xs-12">
...
<div class="row clearfix">
  ...
  <div class="col-md-10"><input type="text" id="datepicker" name="date_register" value="<? echo $payreceivable_row['payreceivable_register']; ?>" required="required"><input name="payreceivable_id" type="hidden" id="payreceivable_id" value="<? echo $payreceivable_id; ?>" /></div>
</div>
<div class="row clearfix">                                
...
<div class="row clearfix">
  ...
  <div class="col-md-10 typehead_staff"><input name="staff_code" type="text" class="textbox" id="staff_code" required="required" value="<? echo $payreceivable_row['staff_code']; ?> - <? echo $payreceivable_row['staff_name']; ?>"></div>
</div>
<div class="row clearfix">
  ...
  <div class="col-md-10 typehead_staff"><input name="payreceivable_tenor" type="text" class="textbox" id="payreceivable_tenor" value="<? echo $payreceivable_row['payreceivable_tenor']; ?>" size="5" required="required">
  kali</div>
</div>
<div class="row clearfix">
  ...
  <div class="col-md-10"><select name="payreceivable_accountdebit" class="textbox" id="payreceivable_accountdebit">
    <?
			$global->payreceivable->book->account_special_create(array("receivable_staff"),$payreceivable_row['payreceivable_accountdebit']);
			?>
    </select></div>
</div>
...
<div class="row clearfix">
  ...
  <div class="col-md-10">
    <textarea name="payreceivable_description" cols="40" rows="5" class="textbox" id="payreceivable_description" required="required"><? echo $payreceivable_row['payreceivable_description']; ?></textarea>
  </div>
</div>
...
<table class="table table-bordered product_order_buy">
  ...
  <?
  $ledgerdetails_list=$global->tbl_list("ledgerdetails","*","ledger_id='".$payreceivable_row['ledger_id']."' AND ledgerdetails_type='K'","",1);
  $j=0;
  for($i=0;$i<count($ledgerdetails_list);$i++){
  $j++;
  $payreceivable_amount_unf=$ledgerdetails_list[$i]['ledgerdetails_amount'];
  $payreceivable_amount=$global->num_format2($payreceivable_amount_unf);
  //get tcode
  $taxonomi_row=$global->db_row("taxonomi","*","taxonomi_id='".$ledgerdetails_list[$i]['taxonomi_id']."'");
  $payreceivable_accountcredit=$taxonomi_row['taxonomi_code']." - ".$taxonomi_row['taxonomi_name'];
  ?>
  <tr id="inner<? echo $j; ?>">
  <td class="listnum_receivable_get">#</td>
  <td><a href="#" class="link_table receivable_get_edit"><div class="payreceivable_accountcredit"><? echo $payreceivable_accountcredit; ?></div><input class="payreceivable_accountcredit_hidden" name="payreceivable_accountcredit_hidden[]" type="hidden" value="<? echo $payreceivable_accountcredit; ?>"/></a></td>
  <td><a href="#" class="link_table receivable_get_edit"><div class="payreceivable_amount"><? echo $payreceivable_amount; ?></div><input class="payreceivable_amount_hidden" name="payreceivable_amount_hidden[]" type="hidden" value="<? echo $payreceivable_amount_unf; ?>"/></a></td>
  <td><a href="javascript:;" class="btn btn-danger" onclick="remove_receivable_get(this);"> <span class="glyphicon glyphicon-minus" aria-hidden="true"></span> </a></td>
  </tr>
  <?
		}
  ?>
  ...
  <td><span id="payreceivable_amount_total"><? echo $payreceivable_amount_total; ?></span><input name="payreceivable_amount_total_hidden" id="payreceivable_amount_total_hidden" type="hidden" value="<? echo $payreceivable_row['payreceivable_amount']; ?>" /></td>
  <td>&nbsp;</td>
  </tr>
...
<div class="box-body table-responsive">
<form method="post" enctype="multipart/form-data" name="form_receivable_edit" id="form_receivable_edit"><input name="inner_id_hidden" type="hidden" id="inner_id_hidden" value="" />
<div class="box-header">
