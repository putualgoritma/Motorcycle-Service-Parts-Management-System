            ...
            <aside class="right-side">                
                ...
                <section class="content">
                    <div class="row"><form action="receivable-edit.php" method="post" enctype="multipart/form-data" name="form" id="form">
                        <div class="col-xs-12">
...
<div class="row clearfix">
  ...
  <div class="col-md-10 typehead_users"><input name="users_code" type="text" class="textbox" id="users_code" required="required" value="<? echo $payreceivable_row['users_code']; ?> - <? echo $payreceivable_row['users_name']; ?>"></div>
</div>
<div class="row clearfix">
  ...
  <div class="col-md-10 typehead_users"><input name="payreceivable_tenor" type="text" class="textbox" id="payreceivable_tenor" value="<? echo $payreceivable_row['payreceivable_tenor']; ?>" size="5" required="required">
  kali</div>
</div>
<div class="row clearfix">
  ...
  <div class="col-md-10"><select name="payreceivable_accountdebit" class="textbox" id="payreceivable_accountdebit">
    <?
			$global->payreceivable->book->account_parent_special_create(array("recievable"),$payreceivable_row['payreceivable_accountdebit']);
			?>
    </select></div>
</div>
