            ...
            <aside class="right-side">                
                ...
                <section class="content">
                    <div class="row"><form action="receivable-min-new.php" method="post" enctype="multipart/form-data" name="form" id="form">
                        <div class="col-xs-12">
...
<div class="row clearfix">
  ...
  <div class="col-md-10"><select name="payreceivable_accountcredit2" class="textbox" id="payreceivable_accountcredit2" disabled="disabled">
    <?
			$global->payreceivable->book->account_parent_special_create(array("recievable"),$payreceivable_accountcredit);
			?>
    </select></div>
</div>
