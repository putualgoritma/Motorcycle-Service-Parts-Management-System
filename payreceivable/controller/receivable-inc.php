...
if(!isset($_SESSION['receivable_users_sessi'])){
$_SESSION['receivable_users_sessi']="";
}
//default view
...
$users_code_value=$_SESSION['receivable_users_sessi'];
//if search
...
$_SESSION['receivable_users_sessi']=$_REQUEST['users_code'];
}
//array set
...
'sort'=>$sort_value,
'join_match'=>" AND ".$date_range_match." AND payreceivable.payreceivable_type = '1'".$users_code_match.$payreceivable_account_match,
'join_id'=>"",
...
$receivable_search_list=$global->tbl_searchjoin_list("payreceivable","payreceivable.*,users.users_name,users.users_code",$def_arr,$search_field_arr,1,$select_num,$qry_str_sort);
//next prev
if($per_page_value<=0){
$total_page=1;
$current_page=1;
