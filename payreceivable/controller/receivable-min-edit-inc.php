...
{
Header("location: receivable-min-edit.php");
exit;
}
...
if(!$valid_date['is_valid']){
	...
	if(!$global->payreceivable->update_receivable($create_arr,$payreceivable_id)){
	...
	//redirect
	Header("location: ../confirm.php?redirect=payreceivable/receivable.php&confirm=".$form_header_lang['edit_button']);
	exit;
}
?>
