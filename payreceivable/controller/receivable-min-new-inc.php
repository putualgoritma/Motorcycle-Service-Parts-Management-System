...
$payreceivable_row=$global->payreceivable->db_row("payreceivable","users_code,payreceivable_accountdebit","payreceivable_id='".$_REQUEST['payreceivable_id']."'");
...
$iset=0;
if(isset($_POST['payreceivable_accountdebit_hidden'])){
...
$payrecievable_set_id.=$_POST['payreceivable_accountcredit2'];
$payreceivable_accountdebit=$_POST['payreceivable_accountcredit2'];
}
//end form handling
