...
//fields_arr
$fields_arr = array(
'bank_code'=>	$global->users->users_lang['form_label_users_lang']['bank_code'],
'bank_name'=>	$global->users->users_lang['form_label_users_lang']['bank_name'],
);
...
while (($data_csv = fgetcsv($handle, 0, ",",'"')) !== FALSE)
	...
	if($i==0)
		...
		$global->db_insert_update('bank',$insert_arr,'bank_code');
		}
	$i++;
	}
//check if break
...
//default view
$search_value="";
$sort_value="bank_code ASC";
$pageset_value=0;
$per_page_value=0;

//query
$search_field_arr=array("bank_code","bank_name");
$def_arr=array(
...
$bank_search_list=$global->tbl_search_list("bank","*",$def_arr,$search_field_arr,1,$select_num,$qry_str_sort);
...
//get out
$out=$global->csv_generate($fields_arr,$bank_search_list);
