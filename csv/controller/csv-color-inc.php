...
'color_name'=>	$global->product_order->product_order_lang['form_label_product_order_lang']['color_name'],
);
...
while (($data_csv = fgetcsv($handle, 0, ",",'"')) !== FALSE)
	...
	if($i==0)
		...
		$global->db_insert_update('color',$insert_arr,'color_code');
		}
	$i++;
	}
//check if break
...
$color_search_list=$global->tbl_search_list("color","*",$def_arr,$search_field_arr,1,$select_num,$qry_str_sort);
...
//get out
$out=$global->csv_generate($fields_arr,$color_search_list);
