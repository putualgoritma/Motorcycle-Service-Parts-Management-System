...
'religion_name'=>	$global->users->users_lang['form_label_users_lang']['religion_name'],
);
...
while (($data_csv = fgetcsv($handle, 0, ",",'"')) !== FALSE)
	...
	if($i==0)
		...
		$global->db_insert_update('religion',$insert_arr,'religion_code');
		}
	$i++;
	}
//check if break
...
$religion_search_list=$global->tbl_search_list("religion","*",$def_arr,$search_field_arr,1,$select_num,$qry_str_sort);
...
//get out
$out=$global->csv_generate($fields_arr,$religion_search_list);
