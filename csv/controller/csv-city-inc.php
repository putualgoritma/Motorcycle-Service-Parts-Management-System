...
//fields_arr
$fields_arr = array(
'city_code'=>	$global->users->users_lang['form_label_users_lang']['city_code'],
'city_name'=>	$global->users->users_lang['form_label_users_lang']['city_name'],
'city_province'=>	$global->users->users_lang['form_label_users_lang']['city_province'],
);
...
while (($data_csv = fgetcsv($handle, 0, ",",'"')) !== FALSE)
	...
	if($i==0)
		...
		$global->db_insert_update('city',$insert_arr,'city_code');
		}
	$i++;
	}
//check if break
...
//get out
$out=$global->csv_generate($fields_arr,$city_search_list);
