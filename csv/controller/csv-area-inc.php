...
//fields_arr
$fields_arr = array(
'area_code'=>	$global->users->users_lang['form_label_users_lang']['area_code'],
'area_name'=>	$global->users->users_lang['form_label_users_lang']['area_name'],
'area_range'=>	$global->users->users_lang['form_label_users_lang']['area_range'],
);
...
while (($data_csv = fgetcsv($handle, 0, ",",'"')) !== FALSE)
	...
	if($i==0)
		...
		$global->db_insert_update('area',$insert_arr,'area_code');
		}
	$i++;
	}
//check if break
...
//default view
$search_value="";
$sort_value="area_code ASC";
$pageset_value=0;
$per_page_value=0;

//query
$search_field_arr=array("area_code","area_name");
$def_arr=array(
...
$area_search_list=$global->tbl_search_list("area","*",$def_arr,$search_field_arr,1,$select_num,$qry_str_sort);
...
//get out
$out=$global->csv_generate($fields_arr,$area_search_list);
