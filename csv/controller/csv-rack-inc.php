...
'rack_description'=>	$global->product_order->product_order_lang['form_label_product_order_lang']['rack_description'],
);
...
while (($data_csv = fgetcsv($handle, 0, ",",'"')) !== FALSE)
	...
	if($i==0)
		...
		$global->db_insert_update('rack',$insert_arr,'rack_code');
		}
	$i++;
	}
//check if break
...
$rack_search_list=$global->tbl_search_list("rack","*",$def_arr,$search_field_arr,1,$select_num,$qry_str_sort);
...
//get out
$out=$global->csv_generate($fields_arr,$rack_search_list);
