...
//fields_arr
$fields_arr = array(
'motorcycle_model_code'=>	$global->product_order->product_order_lang['form_label_product_order_lang']['motorcycle_model_code'],
'motorcycle_model_name'=>	$global->product_order->product_order_lang['form_label_product_order_lang']['motorcycle_model_name'],
);
...
while (($data_csv = fgetcsv($handle, 0, ",",'"')) !== FALSE)
	...
	if($i==0)
		...
		//insert items
		$insert_arr = array(
		'motorcycle_model_code'=>	$data['motorcycle_model_code'],
		'motorcycle_model_name'=>	$data['motorcycle_model_name'],
		);
		$global->db_insert_update('motorcycle_model',$insert_arr,'motorcycle_model_code');
		}
	$i++;
	}
//check if break
...
$year_value="%";
$month_value="%";
$sort_value="motorcycle_model_code ASC";
$pageset_value=0;
$per_page_value=0;
...
$motorcycle_model_search_list=$global->tbl_search_list("motorcycle_model","*",$def_arr,$search_field_arr,1,$select_num,$qry_str_sort);
...
//get out
$out=$global->csv_generate($fields_arr,$motorcycle_model_search_list);
