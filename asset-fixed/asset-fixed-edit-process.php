...
$asset_fixed_id=$_POST['asset_fixed_id'];
...
//create asset fixed
if(!$global->asset_fixed->update_asset_fixed($create_arr,$asset_fixed_id)){
	$global->asset_fixed->error_message($global->asset_fixed->err_msg);
	}
	
//redirect
//Header("location: asset-fixed.php");
Header("location: ../confirm.php?redirect=asset-fixed/asset-fixed.php&confirm=".$form_header_lang['edit_button']);
exit;
}
?>