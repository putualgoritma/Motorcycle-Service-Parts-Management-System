...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
  ...
  <tr>
    <td align=\"center\"><strong>SLIP GAJI KARYAWAN (PART)</strong></td>
  </tr>
  <tr>
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" class=\"tablepadding\">
  <tr>
    <td width=\"20%\">&nbsp;</td>
    <td width=\"40%\"><strong><u>Pendapatan Part Harian</u></strong></td>
...
$html .= "
  <tr>
    ...
    <td width=\"40%\">".$global->num_format2($product_fee)."</td>
    <td width=\"40%\"></td>
  </tr>
  ";
  endfor;
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" class=\"tablepadding\">
  ...
  $html .= "
  <tr>
    <td><strong>Pendapatan Part:</strong></td>
    <td>Rp. ".$global->num_format2($salary_slip_commission_part)."</td>
    <td><strong></strong></td>
    <td></td>
  </tr>
  ";
    $income_total = $salary_slip_commission_part;
