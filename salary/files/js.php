...
function staff_income_cal() {
	var income_total = parseInt($("#salary_slip_basic").val().replace(/[^0-9.-]+/g,""))+parseInt($("#salary_slip_position").val().replace(/[^0-9.-]+/g,""))+parseInt($("#salary_slip_transport").val().replace(/[^0-9.-]+/g,""))+parseInt($("#salary_slip_food").val().replace(/[^0-9.-]+/g,""))+parseInt($("#salary_slip_insurance").val().replace(/[^0-9.-]+/g,""))+parseInt($("#salary_slip_insentif_daily").val().replace(/[^0-9.-]+/g,""))+parseInt($("#salary_slip_commission_part_service").val().replace(/[^0-9.-]+/g,""))+parseInt($("#salary_slip_insentif_unit_entry").val().replace(/[^0-9.-]+/g,""))+parseInt($("#salary_slip_insentif_product").val().replace(/[^0-9.-]+/g,""))+parseInt($("#salary_slip_insentif_service").val().replace(/[^0-9.-]+/g,""))+parseInt($("#salary_slip_insentif_bonus").val().replace(/[^0-9.-]+/g,""))+parseInt($("#salary_slip_insentif_no_alfa").val().replace(/[^0-9.-]+/g,""))+parseInt($("#salary_slip_fee_picket").val().replace(/[^0-9.-]+/g,""));
