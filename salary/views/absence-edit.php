            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1><? echo $global->salary->salary_lang['form_header_salary_lang']['absence_edit']; ?></h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><? echo $global->salary->salary_lang['form_header_salary_lang']['absence_edit']; ?></li>
                    </ol>
                </section>
            <!-- Main content -->
            ...
            <form action="absence-edit.php" method="post" enctype="multipart/form-data" name="form" id="form">
<div>
...
<div class="col-md-10"><input name="absence_id" type="hidden" id="absence_id" value="<? echo $absence_row['absence_id']; ?>"/><input name="absence_date" type="text" class="textbox" id="absence_date" value="<? echo $_REQUEST['absence_date']; ?>" readonly="readonly"></div>
</div>
<div class="row clearfix">                                
