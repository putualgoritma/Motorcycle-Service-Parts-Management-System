            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1><? echo $global->users->users_lang['form_header_users_lang']['customer_new']; ?></h1>
                    <? if(!isset($popup)){?>
                    <ol class="breadcrumb">
                        <li><a href="<? echo $path; ?>index.php"><i class="fa fa-home"></i> Home</a></li>
                        <li><a href="<? echo $path; ?>index-sub.php?module_code=<? echo $parent_active; ?>"> Master Data</a></li>
                        <li><a href="<? echo $link_list; ?>"><? echo $global->users->users_lang['form_header_users_lang']['customer']; ?></a></li>
                        <li class="active"><? echo $global->users->users_lang['form_header_users_lang']['customer_new']; ?></li>
                    </ol>
                    <? }?>
                </section>
            <!-- Main content -->
...
<? }?>
<div>
    <p><strong><u><? if(isset($popup_edit)){?><? echo $global->users->users_lang['form_header_users_lang']['customer_edit']; ?><? }else{?><? echo $global->users->users_lang['form_header_users_lang']['customer_new']; ?><? }?>: </u></strong></p>
    <div>&nbsp;</div>                           
     </div><!-- /.box-header -->
...
?>
<option value="<? echo $customer_level_list[$i_list1]['customer_level_code']; ?>"><? echo $customer_level_list[$i_list1]['customer_level_code']; ?> - <? echo $customer_level_list[$i_list1]['customer_level_name']; ?></option>
<?php
}
?>
    </select></div>
...
<div class="row clearfix append_div_area"<? if($app_type!="ahass"){ ?> style="display:none"<? } ?>>                                
  <div class="<? echo $col_md1; ?>"><strong><? echo $global->users->users_lang['form_label_users_lang']['area_name']; ?>:</strong></div>
<div class="<? echo $col_md2; ?>"><select name="area_code" class="textbox selectbox" id="area_code"<? if($app_type=="ahass"){ ?> required="required"<? } ?>>
                      <option value="">None</option>
					  <?
...
<div class="row clearfix">
  ...
  <div class="<? echo $col_md2; ?>"><input name="users_idnumber" type="text" class="textbox" id="users_idnumber"></div>
</div>

<div class="row clearfix">                                
  <div class="<? echo $col_md1; ?>"><strong><? echo $global->users->users_lang['form_label_users_lang']['users_birthday']; ?>:</strong></div>
<div class="<? echo $col_md2; ?>"><input type="text" id="datepicker" name="users_birthday" class="nxt_tab"></div>
</div>
<div class="row clearfix">                                
  <div class="<? echo $col_md1; ?>"><strong><? echo $global->users->users_lang['form_label_users_lang']['religion_name']; ?>:</strong></div>
<div class="<? echo $col_md2; ?>"><select name="religion_code" class="textbox selectbox" id="religion_code">
                      <option value="">None</option>
					  <?
...
<div class="<? echo $col_md2; ?> typehead_village"><input name="village_code" type="text" class="textbox" id="village_code"></div>
</div>
</div>

<div class="clear">&nbsp;</div>
<div class="clear">&nbsp;</div>
<section id="profile-tabs"<? if(isset($popup)){?> class="td_hide"<? }?>>
...
<div class="tab-content<? if(isset($popup)){?> td_hide<? }?>">
...
<div class="row clearfix">
  <div class="col-md-12">
  <div class="row clearfix">
  <div class="<? echo $col_md1; ?>"><strong>Batas Hari Kredit:</strong></div>
<div class="<? echo $col_md2; ?>">
  <input name="users_credit_max_days" type="text" class="textbox" id="users_credit_max_days" size="3" />
</div>
</div>
    <div class="row clearfix">
  <div class="<? echo $col_md1; ?>"><strong>Batas Jumlah Kredit:</strong></div>
<div class="<? echo $col_md2; ?>">
  <input name="users_credit_max_amount" type="text" class="textbox" id="users_credit_max_amount" />
</div>
</div>
<div class="row clearfix">
  <div class="<? echo $col_md1; ?>"><strong>Group Customer:</strong></div>
<div class="<? echo $col_md2; ?>">
...
?>
<option value="<? echo $users_group_list[$i_list1]['users_group_code']; ?>"><? echo $users_group_list[$i_list1]['users_group_name']; ?></option>
<?php
}
?>
  </select>
...
<div class="row clearfix">
  ...
  <div>&nbsp;</div>
    <div class="row clearfix">
      <div class="<? echo $col_md1; ?>"><strong>Nama:</strong></div>
      <div class="<? echo $col_md2; ?>">
        <input name="users_contact_name" type="text" class="textbox" id="users_contact_name" />
      </div>
    </div>
    <div class="row clearfix">
      <div class="<? echo $col_md1; ?>"><strong>Tlp/HP:</strong></div>
      <div class="<? echo $col_md2; ?>">
        <input name="users_contact_phone" type="text" class="textbox" id="users_contact_phone" />
      </div>
    </div>
    <div class="row clearfix">
      <div class="<? echo $col_md1; ?>"><strong>Jabatan:</strong></div>
      <div class="<? echo $col_md2; ?>">
        <input name="users_contact_position" type="text" class="textbox" id="users_contact_position" />
      </div>
    </div>
  ...
  <div>&nbsp;</div>
    <div class="row clearfix">
      <div class="<? echo $col_md1; ?>"><strong>Nama:</strong></div>
      <div class="<? echo $col_md2; ?>">
        <input name="users_contact_name2" type="text" class="textbox" id="users_contact_name2" />
      </div>
    </div>
    <div class="row clearfix">
      <div class="<? echo $col_md1; ?>"><strong>Tlp/HP:</strong></div>
      <div class="<? echo $col_md2; ?>">
        <input name="users_contact_phone2" type="text" class="textbox" id="users_contact_phone2" />
      </div>
    </div>
    <div class="row clearfix">
      <div class="<? echo $col_md1; ?>"><strong>Jabatan:</strong></div>
      <div class="<? echo $col_md2; ?>">
        <input name="users_contact_position2" type="text" class="textbox" id="users_contact_position2" />
      </div>
    </div>
  ...
  <div>&nbsp;</div>
    <div class="row clearfix">
      <div class="<? echo $col_md1; ?>"><strong>Nama:</strong></div>
      <div class="<? echo $col_md2; ?>">
        <input name="users_contact_name3" type="text" class="textbox" id="users_contact_name3" />
      </div>
    </div>
    <div class="row clearfix">
      <div class="<? echo $col_md1; ?>"><strong>Tlp/HP:</strong></div>
      <div class="<? echo $col_md2; ?>">
        <input name="users_contact_phone3" type="text" class="textbox" id="users_contact_phone3" />
      </div>
    </div>
    <div class="row clearfix">
      <div class="<? echo $col_md1; ?>"><strong>Jabatan:</strong></div>
      <div class="<? echo $col_md2; ?>">
        <input name="users_contact_position3" type="text" class="textbox" id="users_contact_position3" />
      </div>
    </div>
...
<div class="row clearfix">
  <div class="col-md-12">
    <div class="row clearfix">
      <div class="<? echo $col_md1; ?>"><strong>Catatan/Info Lain:</strong></div>
<div class="<? echo $col_md2; ?>">
  <textarea name="users_note" cols="50" rows="5" class="textbox" id="users_note"></textarea>
</div>
</div>
  </div>
</div>
