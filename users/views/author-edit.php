            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1><? echo $global->users->users_lang['form_header_users_lang']['author_edit']; ?></h1>
                    <ol class="breadcrumb">
                        <li><a href="<? echo $path; ?>index.php"><i class="fa fa-home"></i> Home</a></li>
                        <li><a href="<? echo $path; ?>index-sub.php?module_code=<? echo $parent_active; ?>"> Master Data</a></li>
                        <li><a href="author.php"><? echo $global->users->users_lang['form_header_users_lang']['author']; ?></a></li>
                        <li class="active"><? echo $global->users->users_lang['form_header_users_lang']['author_edit']; ?></li>
                    </ol>
                </section>
            <!-- Main content -->
            ...
            <form action="author-edit.php" method="post" enctype="multipart/form-data" name="form" id="form">
<div>
    <p><strong><u><? echo $global->users->users_lang['form_header_users_lang']['author_edit']; ?>: </u></strong></p>
    <div>&nbsp;</div>                           
     </div><!-- /.box-header -->
...
<div class="col-md-10"><input name="contact_name" type="text" class="textbox lastinedit" id="contact_name" value="<? echo $contact_row['contact_name']; ?>"></div>
</div>
<div class="clear">&nbsp;</div>
<div class="row clearfix">
