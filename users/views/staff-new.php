            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1><? echo $global->users->users_lang['form_header_users_lang']['staff_new']; ?></h1>
                    <? if(!isset($popup)){?>
                    <ol class="breadcrumb">
                        <li><a href="<? echo $path; ?>index.php"><i class="fa fa-home"></i> Home</a></li>
                        <li><a href="<? echo $path; ?>index-sub.php?module_code=<? echo $parent_active; ?>"> Master Data</a></li>
                        <li><a href="<? echo $link_list; ?>"><? echo $global->users->users_lang['form_header_users_lang']['staff']; ?></a></li>
                        <li class="active"><? echo $global->users->users_lang['form_header_users_lang']['staff_new']; ?></li>
                    </ol>
                    <? }?>
                </section>
            <!-- Main content -->
...
<div>
    <p><strong><u><? echo $global->users->users_lang['form_header_users_lang']['staff_new']; ?>: </u></strong></p>
    <div>&nbsp;</div>                           
     </div><!-- /.box-header -->
 
<div class="row clearfix">
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_code']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_code" type="text" class="textbox firstin" id="staff_code" value="<? echo $staff_code_generation;?>" required="required"></div>
</div>
<div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_name']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_name" type="text" class="textbox" id="staff_name" required="required"></div>
</div>
<div class="row clearfix">                                
  ...
  <div class="col-md-10"><select name="staff_gender" class="textbox" id="staff_gender">
    ...
    <option<? if($list_inc==0){?> selected="selected"<? }?> value="<? echo $form_selectlist_lang['gender'][$list_inc][0]; ?>"><? echo $form_selectlist_lang['gender'][$list_inc][1]; ?></option>
    <? }?>
    </select></div>
</div>
<div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_place_born']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_place_born" type="text" class="textbox" id="staff_place_born"></div>
</div>
<div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_date_born']; ?>:</strong></div>
<div class="col-md-10"><input type="text" id="staff_date_born" name="staff_date_born" class="nxt_tab datepicker" value="<? echo $date_def; ?>"></div>
</div>
<div class="row clearfix">                                
...
<div class="col-md-10"><select name="education_code" class="textbox selectbox" id="education_code">
					  ...
					  <?
						...
						for($i_list=0;$i_list<count($select_list);$i_list++){
						?>
					  <option value="<? echo $select_list[$i_list]['education_code']; ?>"><? echo $select_list[$i_list]['education_name']; ?></option>
					  <?
							}
						?>
                      </select></div>
...
<div class="row clearfix">
  ...
  <div class="col-md-10"><textarea name="staff_address" cols="40" rows="4" class="textbox" id="staff_address"></textarea></div>
</div>

<div class="row clearfix">
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_phone']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_phone" type="text" class="textbox" id="staff_phone"></div>
</div>

<div class="row clearfix">
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_email']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_email" type="text" class="textbox" id="staff_email"></div>
</div>

<div class="row clearfix">
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_id_nom']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_id_nom" type="text" class="textbox" id="staff_id_nom"></div>
</div>
<div class="row clearfix">
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_description']; ?>:</strong></div>
  <div class="col-md-10"><textarea name="staff_description" cols="40" rows="4" class="textbox" id="staff_description"></textarea></div>
</div>
<div class="clear">&nbsp;</div>
...
<div class="col-md-10"><input type="text" id="staff_date_start_work" name="staff_date_start_work" class="nxt_tab datepicker" value="<? echo $date_def; ?>"></div>
</div>
    <div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_date_end_work']; ?>:</strong></div>
<div class="col-md-10"><input type="text" id="staff_date_end_work" name="staff_date_end_work" class="nxt_tab datepicker" value="<? echo $date_def; ?>"></div>
</div>
<div class="row clearfix">                                
  ...
  <div class="col-md-10"><select name="staff_status" class="textbox" id="staff_status">
    ...
    <option<? if($list_inc==0){?> selected="selected"<? }?> value="<? echo $form_selectlist_lang['staff_status'][$list_inc][0]; ?>"><? echo $form_selectlist_lang['staff_status'][$list_inc][1]; ?></option>
    <? }?>
    </select></div>
</div>
  <div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_date_start_contract']; ?>:</strong></div>
<div class="col-md-10"><input type="text" id="staff_date_start_contract" name="staff_date_start_contract" class="nxt_tab datepicker" value="<? echo $date_def; ?>"></div>
</div>
    <div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_date_end_contract']; ?>:</strong></div>
<div class="col-md-10"><input type="text" id="staff_date_end_contract" name="staff_date_end_contract" class="nxt_tab datepicker" value="<? echo $date_def; ?>"></div>
</div>
<div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_contract_num']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_contract_num" type="text" class="textbox" id="staff_contract_num"></div>
</div>
<div class="row clearfix">                                
...
<div class="col-md-10"><select name="position_code" class="textbox selectbox" id="position_code">
					  ...
					  <?
						...
						for($i_list=0;$i_list<count($select_list);$i_list++){
						?>
					  <option value="<? echo $select_list[$i_list]['position_code']; ?>"><? echo $select_list[$i_list]['position_name']; ?></option>
					  <?
							}
						?>
                      </select></div>
...
<div class="col-md-10">
    <label>
      <input name="staff_pit_status" type="radio" id="staff_pit_status_0" value="pit" checked="checked" />
      Pit</label>
    <label>
      <input type="radio" name="staff_pit_status" value="nonpit" id="staff_pit_status_1" />
      Non Pit</label>
</div>
</div>
<div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_pmt1']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_pmt1" type="text" class="textbox" id="staff_pmt1"></div>
</div>
<div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_pmt2']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_pmt2" type="text" class="textbox" id="staff_pmt2"></div>
</div>
<div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_pmt3']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_pmt3" type="text" class="textbox" id="staff_pmt3"></div>
</div>
<div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_sa']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_sa" type="text" class="textbox" id="staff_sa"></div>
</div>
<div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_paa']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_paa" type="text" class="textbox" id="staff_paa"></div>
</div>
<div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_csm']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_csm" type="text" class="textbox" id="staff_csm"></div>
</div>
<div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_css']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_css" type="text" class="textbox" id="staff_css"></div>
</div>
...
<div class="row clearfix">
  ...
  <div class="col-md-10">
    <input name="staff_fee_status" type="checkbox" id="staff_fee_status" checked="checked" />
  </div>
</div>
<div class="row clearfix">
...
<div class="col-md-10">
    <label>
      <input name="staff_fee_system" type="radio" id="staff_fee_system_0" value="item" checked="checked" />
      Per Item</label>
    <label>
      <input type="radio" name="staff_fee_system" value="invoice" id="staff_fee_system_1" />
      Per Faktur</label>
    <label>
      <input type="radio" name="staff_fee_system" value="custome" id="staff_fee_system_2" />
...
<div class="col-md-10">
    <label>
      <input name="staff_fee_system_type" type="radio" id="staff_fee_system_type_0" value="percent" checked="checked" />
      Prosentase</label>
    <label>
      <input type="radio" name="staff_fee_system_type" value="nominal" id="staff_fee_system_type_1" />
      Nominal</label>
</div>
</div>
<div class="row clearfix" id="staff_fee_system_percent">
<div class="col-md-2"><strong>Prosentase:</strong></div>
<div class="col-md-10"><input name="staff_fee_system_percent_val" type="text" class="textbox" id="staff_fee_system_percent_val" size="3" placeholder="0">
  % dari 
...
<div class="row clearfix" id="staff_fee_system_nominal" style="display:none">
<div class="col-md-2"><strong>Nominal:</strong></div>
<div class="col-md-10"><input name="staff_fee_system_nominal_val" type="text" class="textbox" id="staff_fee_system_nominal_val" placeholder="0">
</div>
</div>
  </div>
</div>
...
<div class="row clearfix">
  ...
  <div class="col-md-10"><input name="staff_salary_basic" type="text" class="textbox" id="staff_salary_basic"></div>
</div>
<div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_salary_position']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_salary_position" type="text" class="textbox" id="staff_salary_position"></div>
</div>
<div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_salary_transport']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_salary_transport" type="text" class="textbox" id="staff_salary_transport"></div>
</div>
<div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_salary_food']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_salary_food" type="text" class="textbox" id="staff_salary_food"></div>
</div>
<div class="row clearfix">                                
  <div class="col-md-2"><strong><? echo $global->users->users_lang['form_label_users_lang']['staff_salary_insurance']; ?>:</strong></div>
  <div class="col-md-10"><input name="staff_salary_insurance" type="text" class="textbox" id="staff_salary_insurance"></div>
</div>
  </div>
</div>
