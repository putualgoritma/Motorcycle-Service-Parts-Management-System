...
$staff_row=$global->users->db_row("staff","*","staff_id='".$staff_id."'");
$religion_row=$global->users->db_row("religion","*","religion_code='".$staff_row['religion_code']."'");
$religion_code=$religion_row['religion_code']." - ".$religion_row['religion_name'];
$education_row=$global->users->db_row("education","*","education_code='".$staff_row['education_code']."'");
$education_code=$education_row['education_code']." - ".$education_row['education_name'];
$position_row=$global->users->db_row("position","*","position_code='".$staff_row['position_code']."'");
$position_code=$position_row['position_code']." - ".$position_row['position_name'];
//submit
...
//create asset fixed
if(!$global->users->update_staff($insert_arr,$staff_id)){
