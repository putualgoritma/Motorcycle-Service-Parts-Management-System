...
$cash_taxonomi=$global->db_fldrow("ledgerdetails","taxonomi_id","ledger_id='".$ledger_id."' AND ledgerdetails_type='K'");
$register_exp = explode('/', $ledger_row['ledger_register']);
$ledger_register=$register_exp[0]."/".$register_exp[1]."/".$register_exp[2];
$cash_amount=$global->book->ledger_total_dk($ledger_id,"D");
...
'ledgerdetails_subsidiary'=>	'cash-credit',
...
//redirect
Header("location: cash-expense.php?confirm=".$form_header_lang['edit_button']);
exit;
}
?>