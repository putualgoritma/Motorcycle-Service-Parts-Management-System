...
<?
//session init
if(!isset($_SESSION['cash_search_sessi'])){
$_SESSION['cash_search_sessi']="";
}
if(!isset($_SESSION['cash_drange1_sessi'])){
$_SESSION['cash_drange1_sessi']="01/".date('m')."/".date('Y');
}
if(!isset($_SESSION['cash_drange2_sessi'])){
$_SESSION['cash_drange2_sessi']=date('d')."/".date('m')."/".date('Y');
}
if(!isset($_SESSION['cash_account_sessi'])){
$_SESSION['cash_account_sessi']=0;
}
if(!isset($_SESSION['cash_sort_sessi'])){
$_SESSION['cash_sort_sessi']="ledger_registernum DESC, ledger_id DESC";
}
if(!isset($_SESSION['cash_pageset_sessi'])){
$_SESSION['cash_pageset_sessi']=0;
}
if(!isset($_SESSION['cash_per_page_sessi'])){
$_SESSION['cash_per_page_sessi']=50;
}
//default view
$search_value=$_SESSION['cash_search_sessi'];
$pageset_value=$_SESSION['cash_pageset_sessi'];
$per_page_value=$_SESSION['cash_per_page_sessi'];
$sort_value=$_SESSION['cash_sort_sessi'];
$cash_account_value=$_SESSION['cash_account_sessi'];
$date_range1_value=$global->date_strtonum($_SESSION['cash_drange1_sessi']);
$date_range2_value=$global->date_strtonum($_SESSION['cash_drange2_sessi']);
$ledger_id_qry="";
//if search
if (isset($_REQUEST['search'])){
$search_value=$_REQUEST['search'];
$_SESSION['cash_search_sessi']=$_REQUEST['search'];
}
if (isset($_REQUEST['per_page'])){
$per_page_value=$_REQUEST['per_page'];
$_SESSION['cash_per_page_sessi']=$_REQUEST['per_page'];
}
...
$_SESSION['cash_drange1_sessi']=$_REQUEST['date_range1'];
}
...
$_SESSION['cash_drange2_sessi']=$_REQUEST['date_range2'];
}
//account
if (isset($_REQUEST['cash_account']) && $_REQUEST['cash_account']!=""){
$cash_account_value=$_REQUEST['cash_account'];
$_SESSION['cash_account_sessi']=$_REQUEST['cash_account'];
}
//sort
if (isset($_REQUEST['sort'])){
$sort=$_REQUEST['sort'];
$sort_value=$sort;
$_SESSION['cash_sort_sessi']=$_REQUEST['sort'];
}
//pageset
if (isset($_REQUEST['pageset'])){
$pageset_value=$_REQUEST['pageset'];
$_SESSION['cash_pageset_sessi']=$_REQUEST['pageset'];
}
//array set
$search_field_arr=array("ledger_register","ledger_description","ledger_code");
//account match
$cash_account_match="ledgerdetails.ledgerdetails_subsidiary = 'cash-debit'";
if($cash_account_value!="0"){
$cash_account_match="ledgerdetails.ledgerdetails_subsidiary = 'cash-debit' AND ledgerdetails.taxonomi_id = '".$cash_account_value."'";
}
//date range match
...
'sort'=>$sort_value,
'join_match'=>$date_range_match." AND ledger.ledger_status = 'pmn' AND ledger.ledger_subsidiary = 'cash-debit'".$ledger_id_qry,
'join_id'=>"",
