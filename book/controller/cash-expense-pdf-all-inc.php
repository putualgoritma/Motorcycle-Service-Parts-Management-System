...
//account match
$cash_account_match="ledgerdetails.ledgerdetails_type = 'K'";
if($cash_account_value!="0"){
$cash_account_match="ledgerdetails.ledgerdetails_type = 'K' AND ledgerdetails.taxonomi_id = '".$cash_account_value."'";
}
//date range match
