                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box box-danger">
                                ...
                                <div class="box-body table-responsive"><form action="ledger-general-edit.php" method="post" enctype="multipart/form-data" name="form" id="form">
                                  <input name="ledger_id" type="hidden" id="ledger_id" value="<? echo"$ledger_id";?>" />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-striped">
  ...
  <tr>
    ...
    <th width="34%"><strong><? echo $global->book->book_lang['form_label_book_lang']['taxonomi_name']; ?></strong></th>
    <th width="19%"><strong><? echo $global->book->book_lang['form_label_book_lang']['taxonomi_code']; ?></strong></th>
    <th width="25%"><strong><? echo $global->book->book_lang['form_label_book_lang']['taxonomi_debit']; ?></strong></th>
    <th width="19%"><strong><? echo $global->book->book_lang['form_label_book_lang']['taxonomi_credit']; ?></strong></th>
   ...
   <? 
			...
			for($i=0;$i<$db_select['select_num'];$i++)
				{
				$ledgerdetails_list[$j]['ledgerdetails_id']=$select_data[$i]['ledgerdetails_id'];
				$ledgerdetails_list[$j]['ledgerdetails_type']=$select_data[$i]['ledgerdetails_type'];
				$ledgerdetails_list[$j]['ledgerdetails_amount']=$select_data[$i]['ledgerdetails_amount'];
				
				$taxonomi_id=$select_data[$i]['taxonomi_id'];
				$taxonomi_row=$global->book->db_row("taxonomi","*","taxonomi_id='".$taxonomi_id."'");
				$ledgerdetails_list[$j]['taxonomi_code']=$taxonomi_row['taxonomi_code'];
				$ledgerdetails_list[$j]['taxonomi_name']=$taxonomi_row['taxonomi_name'];
				$j++;
				}
			for($i=0;$i<count($ledgerdetails_list);$i++){
			$bg_color=$global->get_bg("#F9F9F9","#FFFFFF",$inc);
			//total saldo debit or kredit
			if($ledgerdetails_list[$i]['ledgerdetails_type']=="D")	{
			$total_debit=$total_debit + $ledgerdetails_list[$i]['ledgerdetails_amount'];
				}else{
  ...
  <tr id="inner<? echo $ledgerdetails_list[$i]['ledgerdetails_id']; ?>">
    ...
    <td bgcolor="<? echo"$bg_color"; ?>"><a href="#" class="link_table ledger_new_edit"><? echo $ledgerdetails_list[$i]['taxonomi_name']; ?> xx</a></td>
    <td bgcolor="<? echo"$bg_color"; ?>"><a href="#" class="link_table ledger_new_edit"><? echo $ledgerdetails_list[$i]['taxonomi_code']; ?></a></td>
    <td bgcolor="<? echo"$bg_color"; ?>"><? if($ledgerdetails_list[$i]['ledgerdetails_type']=="D"){?>
  ...
  <tr>
    ...
    <td><span id="total_debit"><strong><? echo $site_lang['currency'].$global->num_format($total_debit); ?></strong></span></td>
    <td><span id="total_credit"><strong><? echo $site_lang['currency'].$global->num_format($total_kredit); ?></strong></span></td>
  </tr>
  <tr>
    <th width="3%" height="25" align="center">&nbsp;</td>
    <th width="33%">&nbsp;</th>
    <th width="20%">&nbsp;</th>
    <th width="25%">&nbsp;</th>
    <th width="18%"><a class="btn btn-info" role="button" href="#" data-toggle="modal" data-target="#myModalnew"><i class="fa fa-plus"></i> <? echo $form_header_lang['add_new_kop']; ?></a></th>
    <th align="center" class="td_hide"><strong>&nbsp;</strong></th>
    <th align="center" class="td_hide"><strong>&nbsp;</strong></th>
    <th align="center" class="td_hide"><strong>&nbsp;</strong></th>
    <th align="center" class="td_hide"><strong>&nbsp;</strong></th>
...
<div class="row clearfix">
  ...
  <div class="col-md-10"><input name="ledger_code" type="text" class="textbox hotkey" id="ledger_code" value="<? echo"$ledger_code";?>"></div>
</div>
<div class="row clearfix">
...
<div class="row clearfix">
  ...
  <div class="col-md-10"><button name="Submitprocess" class="btn btn-primary" id="Submitprocess"><? echo $form_header_lang['process_button']; ?></button>&nbsp;</div>
</div> 
<!-- /.box-body -->
                              </form></div><!-- /.box-body -->
                            </div><!-- /.box -->
...
<div class="col-md-8"><button name="Submit" class="btn btn-primary ledger_details_new" id="Submit"><? echo $form_header_lang['add_new_button']; ?></button><img class="ajax_loader" src="../templates/default/img/loading2.gif" width="41" height="31" /></div>
</div>                               
</div>
</div>
        </div> <!-- /.modal-content -->
...
<div class="row clearfix">
<div class="col-md-4">&nbsp;</div>
<div class="col-md-8"><button name="Submit" class="btn btn-primary ledger_details_edit" id="Submitedit"><? echo $form_header_lang['edit_button']; ?></button><img class="ajax_loader" src="../templates/default/img/loading2.gif" width="41" height="31" /></div>
</div> 
