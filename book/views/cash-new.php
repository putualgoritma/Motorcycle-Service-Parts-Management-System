            ...
            <aside class="right-side">                
                ...
                <section class="content">
                    <div class="row"><form action="cash-new.php" method="post" enctype="multipart/form-data" name="form" id="form">
                        <div class="col-xs-12">
...
<p><strong><u><? echo $global->book->book_lang['form_header_book_lang']['cash_debit_new']; ?></u></strong></p>                     
<div class="clear">&nbsp;</div>
