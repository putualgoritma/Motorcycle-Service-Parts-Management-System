            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><? echo $global->book->book_lang['menu_book_lang']['cash_expense_new']; ?></li>
                    </ol>
                </section>

                <!-- Main content -->
                <section class="content">
                    <div class="row"><form action="cash-expense-new.php" method="post" enctype="multipart/form-data" name="form" id="form">
                        <div class="col-xs-12">
...
<p><strong><u><? echo $global->book->book_lang['form_header_book_lang']['cash_expense_new']; ?></u></strong></p>                     
<div class="clear">&nbsp;</div>
