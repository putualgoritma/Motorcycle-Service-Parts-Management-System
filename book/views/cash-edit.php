            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="cash.php"><? echo $global->book->book_lang['form_header_book_lang']['cash_debit']; ?></a></li>
                        <li class="active"><? echo $global->book->book_lang['menu_book_lang']['cash_debit_edit']; ?></li>
                    </ol>
                </section>

                <!-- Main content -->
                <section class="content">
                    <div class="row"><form action="cash-edit.php" method="post" enctype="multipart/form-data" name="form" id="form"><input name="ledger_id" type="hidden" id="ledger_id" value="<? echo"$ledger_id";?>" />
                        <div class="col-xs-12">
...
<p><strong><u><? echo $global->book->book_lang['form_header_book_lang']['cash_debit_edit']; ?></u></strong></p>                     
<div class="clear">&nbsp;</div>
...
<div class="box box-danger">
            ...
            <div>&nbsp;</div>
                                <div class="row clearfix">
<div class="col-md-12 text-center"><button name="Submit" class="btn btn-primary" id="Submit"><? echo $form_header_lang['process_button']; ?>  (F5)</button>&nbsp;<a class="btn btn-warning" onclick="javascript:location.href='cash-edit.php?Submitcancell=true'" id="Submitcancell"><? echo $form_header_lang['cancell_button']; ?>  (F6)</a></div>
</div>
<div>&nbsp;</div>
