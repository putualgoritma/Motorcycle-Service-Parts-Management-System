            ...
            <aside class="right-side">                
                ...
                <section class="content">
                    <div class="row"><form action="ledger-general-new.php" method="post" enctype="multipart/form-data" name="form" id="form">
                        <div class="col-xs-12">
...
<p><strong><u><? echo $global->book->book_lang['form_header_book_lang']['ledger_general_new']; ?></u></strong></p>                     
<div class="clear">&nbsp;</div>
...
<table class="table table-bordered product_order_sale">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><span id="tledger_total_debit">&nbsp;</span></td>
    <td><span id="tledger_total_credit">&nbsp;</span></td>
