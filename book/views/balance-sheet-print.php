...
(<? echo $site_lang['currency']; ?>)</strong></td>
	...
	?>
                                        <tr>
                                          <td align="center" bgcolor="#FFFFFF"><strong><? echo $form_header_lang['amount']; ?></strong></td>
                                          <td align="center" bgcolor="#FFFFFF"><? echo $global->num_format($balance_activa); ?></td>
                                        </tr>
                                      </table></td>
                                      <td valign="top"><table width="100%" border="0" cellpadding="3" cellspacing="0" class="table-bordered">
<tr>
...
<tr>
<td align="center" bgcolor="#FFFFFF"><strong><? echo $form_header_lang['amount']; ?></strong></td>
<td align="center" bgcolor="#FFFFFF"><? echo $global->num_format($balance_payable); ?></td>
</tr>
<tr>
...
<tr>
<td align="center" bgcolor="#FFFFFF"><strong><? echo $form_header_lang['amount']; ?></strong></td>
<td align="center" bgcolor="#FFFFFF"><? echo $global->num_format($balance_equity); ?></td>
</tr>
<tr>
<td align="center" bgcolor="#FFFFFF">&nbsp;</td>
<td align="center" bgcolor="#FFFFFF">&nbsp;</td>
...
<td align="center" bgcolor="#FFFFFF"><? echo $global->num_format($dividen_net); ?></td>
                                    ...
                                    <tr>
                                      <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="3" class="table-bordered">
                                        <tr>
                                          <td width="62%" align="center"><? echo $global->book->book_lang['form_label_book_lang']['ledgerdetails_total']; ?> <? echo $global->book->book_lang['form_label_book_lang']['taxonomi_asset']; ?></td>
                                          <td width="38%" align="center"><? echo $global->num_format($balance_activa); ?></td>
                                        </tr>
                                      </table></td>
