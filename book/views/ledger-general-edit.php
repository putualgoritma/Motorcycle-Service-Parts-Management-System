            ...
            <aside class="right-side">                
                ...
                <section class="content">
                    <div class="row"><form action="ledger-general-edit.php" method="post" enctype="multipart/form-data" name="form" id="form"><input name="ledger_id" type="hidden" id="ledger_id" value="<? echo"$ledger_id";?>" />
                        <div class="col-xs-12">
...
<p><strong><u><? echo $global->book->book_lang['form_header_book_lang']['ledger_general_edit']; ?></u></strong></p>                     
<div class="clear">&nbsp;</div>
...
<table class="table table-bordered product_order_sale">
  ...
  <tr>
    ...
    <th><? echo $form_header_lang['amount']; ?>
    </th>
    <th><? echo $global->book->book_lang['form_label_book_lang']['ledgerdetails_type']; ?></th>
    <th><? echo $global->book->book_lang['form_label_book_lang']['taxonomi_debit']; ?></th>
    <th><? echo $global->book->book_lang['form_label_book_lang']['taxonomi_credit']; ?></th>
    <th>&nbsp;</th>
  </tr>
  </thead>
  ...
  <tr>
    ...
    <input name="taxonomi_code" type="text" class="textbox" id="taxonomi_code" rel="ledgerdetails_amount" placeholder="<? echo $global->book->book_lang['form_label_book_lang']['taxonomi_name']; ?>">&nbsp;<a href="javascript:;" id="taxonomi_view_alink"> <i class="fa fa-edit fa-lg"></i> </a>
    </td>
    <td>
      <input name="ledgerdetails_amount" type="text" class="textbox masknumber" id="ledgerdetails_amount" value="" size="10" min="0" step="0.01" data-number-to-fixed="2" data-number-stepfactor="100" placeholder="<? echo $form_header_lang['amount']; ?>">
    </td>
        <td>
      <select name="ledgerdetails_type" class="textbox lastinlist" id="ledgerdetails_type">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="javascript:;" class="btn btn-success" id="btn_add_list" onclick="tledger_proc();"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> </a></td>
  </tr>
  ...
  <? 
			...
			if($ledgerdetails_type=="K"){
				...
				$ledgerdetails_amount_debit="-";
				$ledgerdetails_amount_credit=$global->num_format2($ledgerdetails_list[$i]['ledgerdetails_amount']);
				$ledgerdetails_amount_debit_val=0;
				$ledgerdetails_amount_credit_val=$ledgerdetails_list[$i]['ledgerdetails_amount'];
			}else{
				$ledgerdetails_type_val="Debit";
				$ledgerdetails_amount_debit=$global->num_format2($ledgerdetails_list[$i]['ledgerdetails_amount']);
				$ledgerdetails_amount_credit="-";
				$ledgerdetails_amount_debit_val=$ledgerdetails_list[$i]['ledgerdetails_amount'];
				$ledgerdetails_amount_credit_val=0;
				}
			?>	
  <tr id="inner<? echo $j; ?>">
  <td class="listnum_texpense"><? echo $j; ?></td>
  <td><a href="#" class="link_table tledger_edit"><div class="taxonomi_scode"><? echo $taxonomi_scode; ?></div><input name="taxonomi_scode_hidden[]" type="hidden" value="<? echo $taxonomi_scode; ?>"/></a></td>
  <td><a href="#" class="link_table tledger_edit"><div class="ledgerdetails_amount">&nbsp;</div><input name="ledgerdetails_amount_hidden[]" type="hidden" value="<? echo $ledgerdetails_list[$i]['ledgerdetails_amount']; ?>"/></a></td>
  
  <td><a href="#" class="link_table tledger_edit"><div class="ledgerdetails_type"><? echo $ledgerdetails_type_val; ?></div><input name="ledgerdetails_type_hidden[]" type="hidden" value="<? echo $ledgerdetails_list[$i]['ledgerdetails_type']; ?>"/></a></td>
  <td><a href="#" class="link_table tledger_edit"><div class="ledgerdetails_amount_debit"><? echo $ledgerdetails_amount_debit; ?></div><input name="ledgerdetails_amount_debit_hidden[]" type="hidden" value="<? echo $ledgerdetails_amount_debit_val; ?>"/></a></td>
  <td><a href="#" class="link_table tledger_edit"><div class="ledgerdetails_amount_credit"><? echo $ledgerdetails_amount_credit; ?></div><input name="ledgerdetails_amount_credit_hidden[]" type="hidden" value="<? echo $ledgerdetails_amount_credit_val; ?>"/></a></td>
  
  <td><a href="javascript:;" class="btn btn-danger" onclick="tledger_remove(this);"> <span class="glyphicon glyphicon-minus" aria-hidden="true"></span> </a></td>
  </tr>
  <?
		}
  ?>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><span id="tledger_total_debit"><? echo $ledger_total_debit_format; ?></span></td>
    <td><span id="tledger_total_credit"><? echo $ledger_total_credit_format; ?></span></td>
    <td><input type="hidden" name="texpense_total_hidden" id="texpense_total_hidden" value="<? echo $dk_amount; ?>">&nbsp;</td>
  </tr>
               </table>
                                 </div>   
                              </div><!-- /.box-body -->
...
<div class="col-md-8"><button name="Submit" class="btn btn-primary tledger_edit_modal" id="Submitedit"><? echo $form_header_lang['edit_button']; ?></button><img class="ajax_loader" src="../templates/default/img/loading2.gif" width="41" height="31"></div>
</div> 
