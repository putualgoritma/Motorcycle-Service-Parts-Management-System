...
?>
<?
if(!isset($_SESSION['warehouse_bag_drange1_sessi'])){
$_SESSION['warehouse_bag_drange1_sessi']="01/".date('m')."/".date('Y');
}
if(!isset($_SESSION['warehouse_bag_drange2_sessi'])){
$_SESSION['warehouse_bag_drange2_sessi']=date('d')."/".date('m')."/".date('Y');
}
//default view
$search_value="";
$pageset_value=0;
...
$date_range1_value=$global->date_strtonum($_SESSION['warehouse_bag_drange1_sessi']);
$date_range2_value=$global->date_strtonum($_SESSION['warehouse_bag_drange2_sessi']);
$warehouse_stock_status_value="";
//if search
...
//status
if (isset($_REQUEST['warehouse_stock_status'])){
$warehouse_stock_status_value=$_REQUEST['warehouse_stock_status'];
}
//sort
...
$_SESSION['warehouse_bag_drange1_sessi']=$_REQUEST['date_range1'];
}
...
$_SESSION['warehouse_bag_drange2_sessi']=$_REQUEST['date_range2'];
}
//array set
...
//status
$warehouse_stock_status_match="";
if($warehouse_stock_status_value!=""){
$warehouse_stock_status_match=" AND warehouse_stock.warehouse_stock_status = '".$warehouse_stock_status_value."'";
}
$def_arr=array(
...
'sort'=>$sort_value,
'join_match'=>$date_range_match.$warehouse_code_match.$warehouse_stock_status_match,
'join_id'=>"",
