<?
//default
$warehouse_stock_code_generation=$global->product_order->generator_warehouse_stock_edit_code('trs');
//cancell
...
//validate form & cek if at least 1 contain 'pos'
...
if($global->tbldata_exist("warehouse_stock","warehouse_stock_id","warehouse_stock_code='".$warehouse_stock_code."'") || $valid_date['date_monthnum']!=$date_nownum){
	$warehouse_stock_code=$global->product_order->generator_warehouse_stock_edit_code("trs",$valid_date['date_monthnum']);
	}
