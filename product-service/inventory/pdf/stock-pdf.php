...
<? include ("../controller/stock-pdf-inc.php"); ?>
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
  ...
  <tr>
    <td align=\"center\"><span style=\"color: #F00\"><strong>MUTASI STOK</strong></span></td>
  </tr>
  <tr>
...
<table width=\"100%\" border=\"0\" cellspacing=\"3\" cellpadding=\"0\" class=\"garis garis2\">
  <tr>
    ...
    <td width=\"5%\"><strong>Awal</strong></td>
    <td width=\"10%\"><strong>Nilai Awal</strong></td>
    <td width=\"5%\"><strong>Masuk</strong></td>
    <td width=\"10%\"><strong>Nilai Masuk</strong></td>
    <td width=\"5%\"><strong>Keluar</strong></td>
    <td width=\"10%\"><strong>Nilai Keluar</strong></td>
    <td width=\"5%\"><strong>Sisa</strong></td>
    <td width=\"10%\"><strong>Nilai Sisa</strong></td>
  </tr>
</table>
<table width=\"100%\" border=\"0\" cellspacing=\"3\" cellpadding=\"0\" class=\"\">
  ...
  $html .= "
  <tr>
	<td width=\"13%\" valign=\"top\">".$warehouse_stock_row['select_data'][$i]['warehouse_stock_register']."</td>
	<td width=\"13%\" height=\"13\" valign=\"top\">".$warehouse_stock_row['select_data'][$i]['product_code']."</td>
    <td width=\"20%\" valign=\"top\">".$warehouse_stock_row['select_data'][$i]['product_name']."</td>
    <td width=\"7%\" valign=\"top\">".$warehouse_stock_row['select_data'][$i]['unit_code']."</td>
    <td width=\"5%\" valign=\"top\">".$warehouse_stock_row['select_data'][$i]['stock_first']."</td>
    <td width=\"10%\" valign=\"top\">".$global->num_format2($warehouse_stock_row['select_data'][$i]['stock_first_amount'])."</td>
    <td width=\"5%\" valign=\"top\">".$stock_in."</td>
    <td width=\"10%\" valign=\"top\">".$global->num_format2($warehouse_stock_row['select_data'][$i]['stock_in_amount'])."</td>
    <td width=\"5%\" valign=\"top\">".$stock_out."</td>
    <td width=\"10%\" valign=\"top\">".$global->num_format2($warehouse_stock_row['select_data'][$i]['stock_out_amount'])."</td>
    <td width=\"5%\" valign=\"top\">".$warehouse_stock_row['select_data'][$i]['stock_last']."</td>
    <td width=\"10%\" valign=\"top\">".$global->num_format2($warehouse_stock_row['select_data'][$i]['stock_last_amount'])."</td>
  </tr>
  ";
		}
	$html .= "
