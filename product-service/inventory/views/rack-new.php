            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['rack_new']; ?></h1>
                    <? if(!isset($popup)){?>
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['rack_new']; ?></li>
                    </ol>
                    <? }?>
                </section>
            <!-- Main content -->
...
<div>
    <p><strong><u><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['rack_new']; ?>: </u></strong></p>
    <div>&nbsp;</div>                           
     </div><!-- /.box-header -->
...
<div class="col-md-10"><input name="rack_code" type="text" class="textbox firstin" id="rack_code" required="required"></div>
</div>
<div class="row clearfix">                                
...
<div class="col-md-10"><input name="rack_description" type="text" class="textbox lastinnew" id="rack_description" required="required"></div>
</div>
<div class="clear">&nbsp;</div>
<div class="row clearfix">
