            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        <? echo $global->product_order->product_order_lang['form_header_product_order_lang']['warehouse_stock_trs_edit']; ?>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="<? echo $path; ?>index.php"><i class="fa fa-home"></i> Home</a></li>
                        <li><a href="<? echo $path; ?>index-sub.php?module_code=<? echo $parent_active; ?>"> Stock/Persediaan</a></li>
                        <li><a href="warehouse-stock-trs.php"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['warehouse_stock']; ?></a></li>
                        <li class="active"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['warehouse_stock_trs_edit']; ?></li>
                    </ol>
                </section>
                <!-- Main content -->
                <section class="content">
                    <div class="row"><form action="warehouse-stock-trs-edit.php" method="post" enctype="multipart/form-data" name="form" id="form">
                        <div class="col-xs-12">
                        <div class="box box-info">
                                <div class="box-header"> 
                                </div><!-- /.box-header -->
                          <div class="box-body table-responsive">
  <p class="title-header"><strong><u><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['warehouse_stock_trs_edit']; ?></u></strong></p>                     
...
<div class="row clearfix">
<div class="col-md-2"><strong><? echo $global->product_order->product_order_lang['form_label_product_order_lang']['warehouse_code_from']; ?>:</strong></div>
<div class="col-md-10"><select name="warehouse_code_from" class="textbox selectbox firstin" id="warehouse_code_from" required="required" rel="warehouse_code">
                      <option value=""<? if($warehouse_stock_row['warehouse_code_from']==""){?> selected="selected"<? }?>>None</option>
					  <?
						$select_list=$global->tbl_list("warehouse","*","","warehouse_name",1);
						for($i_list=0;$i_list<count($select_list);$i_list++){
						?>
					  <option value="<? echo $select_list[$i_list]['warehouse_code']; ?>"<? if($warehouse_stock_row['warehouse_code_from']==$select_list[$i_list]['warehouse_code']){?> selected="selected"<? }?>><? echo $select_list[$i_list]['warehouse_name']; ?></option>
					  <?
							}
						?>
                      </select></div>
...
<div class="col-md-10"><select name="warehouse_code" class="textbox selectbox" id="warehouse_code" required="required" rel="warehouse_stock_code">
...
<div class="box box-danger">
            ...
            <div>&nbsp;</div>
                                <div class="row clearfix">
<div class="col-md-12 text-center"><button name="Submit" class="btn btn-primary" id="Submit"><? echo $form_header_lang['process_button']; ?>  (F5)</button>&nbsp;<a class="btn btn-warning" onclick="javascript:location.href='warehouse-stock-trs-edit.php?Submitcancell=true'" id="Submitcancell"><? echo $form_header_lang['cancell_button']; ?>  (F6)</a></div>
</div>
<div>&nbsp;</div>
...
<div class="box-body table-responsive">
<form action="warehouse-stock-trs-edit-process.php" method="post" enctype="multipart/form-data" name="form" id="form_product_order"><input name="warehouse_stock_id" type="hidden" id="warehouse_stock_id" value="<? echo $warehouse_stock_row['warehouse_stock_id']; ?>" /><input name="inner_id_hidden" type="hidden" id="inner_id_hidden" value="" />
<div class="box-header">
