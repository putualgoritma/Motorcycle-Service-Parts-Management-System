            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        <? echo $global->product_order->product_order_lang['form_header_product_order_lang']['warehouse_bag_edit']; ?>
                    </h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['warehouse_bag_edit']; ?></li>
                    </ol>
                </section>
                <!-- Main content -->
                <section class="content">
                    <div class="row"><form action="warehouse-bag-edit.php" method="post" enctype="multipart/form-data" name="form" id="form">
                        <div class="col-xs-12">
                        <div class="box box-info">
                                <div class="box-header"> 
                                </div><!-- /.box-header -->
                          <div class="box-body table-responsive">
  <p class="title-header"><strong><u><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['warehouse_bag_edit']; ?></u></strong></p>                     
<div class="row clearfix">
<div class="col-md-2"><strong><? echo $form_header_lang['date_input']; ?>:</strong></div>
<div class="col-md-10"><input name="warehouse_stock_id" type="hidden" id="warehouse_stock_id" value="<? echo $warehouse_stock_row['warehouse_stock_id']; ?>" /><input type="text" id="datepicker" name="date_register" value="<? echo $warehouse_stock_row['warehouse_stock_register']; ?>" class="nxt_tab" disabled="disabled"></div>
</div>
<div class="row clearfix">
...
<div class="col-md-10"><select name="warehouse_code" class="textbox selectbox firstin" id="warehouse_code" required="required" rel="warehouse_stock_code" disabled="disabled">
...
<thead>
  ...
  ?>	
    <tr id="inner<? echo $j; ?>">
      ...
      <td><a href="#" class="link_table warehouse_stock_edit_off"><div class="product_bcode"><? echo $product_bcode; ?></div><input name="product_bcode_hidden[]" type="hidden" value="<? echo $product_bcode; ?>"/></a></td>
...
<div class="col-md-10"><textarea name="warehouse_stock_description" cols="40" rows="5" class="textbox" id="warehouse_stock_description" disabled="disabled"><? echo $warehouse_stock_row['warehouse_stock_description']; ?></textarea></div>
</div>
</div>
...
<div class="box box-danger">
            ...
            <div>&nbsp;</div>
                                <div class="row clearfix">
<div class="col-md-12 text-center"><a class="btn btn-warning" onclick="javascript:location.href='warehouse-bag-edit.php?Submitcancell=true'" id="Submitcancell">Tutup</a></div>
</div>
<div>&nbsp;</div>
...
<div class="box-body table-responsive">
<form action="warehouse-bag-edit-process.php" method="post" enctype="multipart/form-data" name="form" id="form_product_order"><input name="warehouse_stock_id" type="hidden" id="warehouse_stock_id" value="<? echo $warehouse_stock_row['warehouse_stock_id']; ?>" /><input name="inner_id_hidden" type="hidden" id="inner_id_hidden" value="" />
<div class="box-header">
