            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_new']; ?></h1>
                    <? if(!isset($popup)){?>
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_new']; ?></li>
                    </ol>
                    <? }?>
                </section>
            <!-- Main content -->
...
<div>
    <p><strong><u><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_new']; ?>: </u></strong></p>
    <div>&nbsp;</div>                           
     </div><!-- /.box-header -->
...
<div class="col-md-8"><input name="product_code" type="text" class="textbox firstin" id="product_code" required="required"></div>
</div>
<div class="row clearfix">                                
...
<div class="col-md-8"><input name="product_name" type="text" class="textbox" id="product_name" required="required"></div>
</div>
<div class="row clearfix">                                
...
<div class="col-md-8"><input name="product_min_stock" type="text" class="textbox" id="product_min_stock" required="required"></div>
</div>
<div class="row clearfix">                                
...
<div class="col-md-8"><input name="product_max_stock" type="text" class="textbox" id="product_max_stock" required="required"></div>
</div>
<div class="row clearfix">                                
...
<div class="col-md-8">
  <input type="checkbox" name="product_fast_moving" id="product_fast_moving" />
</div>
</div>
<div class="row clearfix"<? if($app_type!="ahass"){ ?> style="display:none"<? } ?>>                                
...
<div class="col-md-8">
  <input type="checkbox" name="product_sim_part" id="product_sim_part" />
</div>
</div>
</div>
...
<div class="col-md-8"><select name="unit_code" class="textbox selectbox" id="unit_code" required="required">
					  ...
					  <?
						...
						for($i_list=0;$i_list<count($select_list);$i_list++){
						?>
					  <option value="<? echo $select_list[$i_list]['unit_code']; ?>"><? echo $select_list[$i_list]['unit_name']; ?></option>
					  <?
							}
						?>
                      </select></div>
...
<div class="col-md-8"><input name="product_sprice" type="text" class="textbox masknumber bprice_change" id="product_sprice" required="required"></div>
</div>
<div class="row clearfix"<? if($app_type!="ahass"){ ?> style="display:none"<? } ?>>
...
<div class="col-md-8"><input name="product_disc" type="text" class="textbox masknumber bprice_change" id="product_disc" required="required" value="0"></div>
</div>
...
<div class="col-md-8"><input name="product_bprice" type="text" class="textbox masknumber" id="product_bprice" required="required"></div>
</div>
...
<div class="col-md-8"><input name="product_kpb_disc" type="text" class="textbox masknumber" id="product_kpb_disc" required="required" value="0"></div>
</div>
...
<div class="col-md-10">
    <label>
      <input name="product_commission_type" type="radio" id="product_commission_type1_0" value="percent" checked="checked" />
      Prosentase</label>
    <label>
      <input type="radio" name="product_commission_type" value="nominal" id="product_commission_type1_1" />
      Nominal</label>
</div>
</div>
<div class="row clearfix" id="product_commission_type_percent">
<div class="col-md-2"><strong>Prosentase:</strong></div>
<div class="col-md-10"><input name="product_commission_percent" type="text" class="textbox" id="product_commission_percent" size="3" placeholder="0">
  % dari 
...
<div class="row clearfix" id="product_commission_type_nominal" style="display:none">
<div class="col-md-2"><strong>Nominal:</strong></div>
<div class="col-md-10"><input name="product_commission_nominal" type="text" class="textbox" id="product_commission_nominal" placeholder="0">
</div>
</div>
  </div>
</div>
...
<div class="col-md-10"><input name="product_thumbnail" type="file" class="textbox" id="product_thumbnail" size="36">
</div>
</div>
    <div class="row clearfix">
  <div class="col-md-2"><strong>Catatan/Info Lain:</strong></div>
<div class="col-md-10">
  <textarea name="product_description" cols="50" rows="5" class="textbox" id="product_description"></textarea>
</div>
</div>
  </div>
</div>
