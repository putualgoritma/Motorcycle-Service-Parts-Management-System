...
'sort'=>$sort_value,
'join_match'=>" AND product_fast_moving=1",
'join_id'=>"",
...
$product_search_list=$global->tbl_searchjoin_list("product","product.*,unit.unit_name,unit.unit_code,(product.product_stock+product.product_stock_po-product.product_stock_ht-product.product_stock_so) AS product_estquantity",$def_arr,$search_field_arr,1,$select_num,$qry_str_sort);
