...
<? $parent_active="warehouse-stock"; ?>
<? $page_active="warehouse-stock/warehouse-stock-min"; ?>
<? include ($path."controller/login-sessi.php"); ?>
<? include ("controller/warehouse-stock-min-edit-inc.php"); ?>
<? include ($path."templates/default/top-frame.php"); ?>
<? include ($path."templates/default/separator.php"); ?>
<? include ("views/warehouse-stock-min-edit.php"); ?>
