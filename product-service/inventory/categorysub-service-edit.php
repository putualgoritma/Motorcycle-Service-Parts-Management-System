...
<? $page_active="product-service/inventory/categorysub-service"; ?>
<? include ($path."controller/login-sessi.php"); ?>
<? include ("controller/categorysub-service-edit-inc.php"); ?>
<? include ($path."templates/default/top-frame.php"); ?>
<? include ($path."templates/default/separator.php"); ?>
<? include ("views/categorysub-service-edit.php"); ?>
