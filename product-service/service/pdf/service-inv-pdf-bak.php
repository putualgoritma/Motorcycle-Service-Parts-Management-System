...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
	  <tr>
		<td align=\"right\">Nomer : SRV".$service_order_code."</td>
      </tr>
  <tr>
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
      <tr>
        ...
        <td width=\"20%\">: $motorcycle_code</td>
        <td width=\"20%\">No. Telp/Hp		</td>
        <td width=\"25%\">:	$users_phone</td>
        <td width=\"15%\">Km</td>
        <td width=\"1%\"> : </td>
        <td width=\"10%\" align=\"right\">$service_order_km_now</td>
      </tr>
      <tr>
        <td>Pemilik</td>
        <td>: $users_name</td>
        <td>Type/Warna/Thn	</td>
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
        <tr>
          ...
          <td width=\"29%\">: $staff_code</td>
          <td width=\"12%\">No. PKB</td>
          <td width=\"50%\">: PKB$service_order_code</td>
        </tr>
    </table>
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
        <tr>
