...
//label
$label_pdf['company_bank']=strtoupper($company['company_bank']);
$label_pdf['company_bank_no']=strtoupper($company['company_bank_no']);
$label_pdf['company_bank_id']=strtoupper($company['company_bank_id']);
...
$service_orderdetails_subtotal=$service_orderdetails_list[$i]['service_orderdetails_total'];
...
$service_orderdetails_list_pdf[$i]['service_orderdetails_discount']=$service_orderdetails_list[$i]['service_orderdetails_discount'];
}
...
$product_orderdetails_subtotal=$product_orderdetails_list[$i]['product_orderdetails_total'];
...
$product_orderdetails_list_pdf[$i]['product_orderdetails_discount']=$product_orderdetails_list[$i]['product_orderdetails_discount'];
}
...
//label
$company_bank=$label_pdf['company_bank'];
$company_bank_no=$label_pdf['company_bank_no'];
$company_bank_id=$label_pdf['company_bank_id'];
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
      <tr>
        ...
        <td width=\"24%\"><strong>Nama Jasa</strong></td>
        <td width=\"7%\"><strong>Qty</strong></td>
        <td width=\"13%\"><strong>Harga</strong></td>
        <td width=\"13%\"><strong>Discount</strong></td>
        <td width=\"1%\">&nbsp;</td>
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
    ...
    $service_orderdetails_discount=$service_orderdetails_list_pdf[$i]['service_orderdetails_discount'];
	$html .= "
	  <tr>
        <td width=\"6%\">$inc</td>
        <td width=\"22%\">$service_code</td>
        <td width=\"24%\">$service_name</td>
        <td width=\"7%\">$service_orderdetails_quantity</td>
        <td width=\"13%\"> $service_orderdetails_price</td>
        <td width=\"13%\"> $service_orderdetails_discount %</td>
        <td width=\"1%\">&nbsp;</td>
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
      <tr>
        ...
        <td width=\"24%\"><strong>Nama Part</strong></td>
        <td width=\"7%\"><strong>Qty</strong></td>
        <td width=\"13%\"><strong>Harga</strong></td>
        <td width=\"13%\"><strong>Discount</strong></td>
        <td width=\"1%\">&nbsp;</td>
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
    ...
    $product_orderdetails_discount=$product_orderdetails_list_pdf[$i]['product_orderdetails_discount'];
	$html .= "
	  <tr>
        <td width=\"6%\">$inc</td>
        ...
        <td width=\"13%\"> $product_orderdetails_discount %</td>
        <td width=\"1%\">&nbsp;</td>
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
		...
		<tr>
          <td align=\"center\">&nbsp;</td>
          <td class=\"garis2\" align=\"center\">$contact_code</td>
          <td align=\"center\">&nbsp;</td>
  ...
  <tr>
       ...
       <tr>
          <td width=\"15%\" align=\"left\" style=\"vertical-align: top;\">Nomor Rekening:</td>
          <td width=\"90%\" align=\"left\" style=\"vertical-align: top;\">$company_bank_no <br> $company_bank_id <br> $company_bank</td>
       </tr>
    </table>   
</body>
</html>
