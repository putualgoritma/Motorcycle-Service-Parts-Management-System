...
<div class=\"col-md-3\"><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
...
<div class=\"col-md-7\"><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">

  <tr>

    <td><strong>IV. PENJUALAN SUKU CADANG LANGSUNG</strong></td>
...
<div class=\"col-md-7\">
  ...
  <table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">
	...
	<tr>
      ...
      <td width=\"27%\">".$j.". ".$product_in_product_order_row['select_data'][$i]['category_name']."</td>

      <td width=\"2%\">:</td>

      <td width=\"12%\" align=\"right\">".$global->num_format2($product_in_product_order_row['select_data'][$i]['price'])."</td>
	...
	<tr>
      ...
      <td align=\"right\"><strong>".$global->num_format2($product_in_total)."</strong></td>
...
<div class=\"col-md-3\"><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
  ...
  <tr>
    ...
    <td><strong>III. PENJUALAN SUKU CADANG SERVICE</strong></td>
...
<div class=\"col-md-7\"><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
  ...
  <tr>
    ...
    <td width=\"40%\"><strong>V. PENGHASILAN BENGKEL</strong></td>

	<td width=\"60%\"><strong><u>".$global->num_format2($total_amount)."</u></strong></td>
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
  ...
  <tr>
    ...
    <td width=\"18%\">".$j.". ".$product_in_service_order_row['select_data'][$i]['category_name']."</td>

    <td width=\"1%\">:</td>

    <td width=\"10%\" align=\"right\">".$global->num_format2($product_in_service_order_row['select_data'][$i]['price'])."</td>
  ...
  ";
	...
	<tr>
      ...
      <td align=\"right\"><strong>".$global->num_format2($product_in_service_total)."</strong></td>
...
//$mpdf = new \Mpdf\Mpdf(['mode' => 'utf-8', 'format' => [10, 20]]);
