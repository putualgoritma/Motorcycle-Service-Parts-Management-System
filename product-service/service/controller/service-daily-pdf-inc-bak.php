...
if (isset($_REQUEST['service_order_register'])) {
    ...
    $service_order_register_start = "04/06/2024";
    $service_order_register = "04/06/2024";
}
//get datenum
...
$service_in_service_order_row = $global->db_qry_data("SELECT GROUP_CONCAT(service_order.service_order_id),motorcycle_type.motorcycle_type_code,motorcycle_type.motorcycle_type_name,category.category_code,motorcycle.motorcycle_type_code as motorcycle_type_code_def,
