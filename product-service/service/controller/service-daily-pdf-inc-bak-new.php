...
$service_in_service_order_arr[$j]['motorcycle_type_name']=$service_in_service_order_row['select_data'][$i]['motorcycle_type_name']?$service_in_service_order_row['select_data'][$i]['motorcycle_type_name']:$service_in_service_order_row['select_data'][$i]['motorcycle_type_code'];
