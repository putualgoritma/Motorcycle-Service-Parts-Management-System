...
//qry service in service_order group by category
$service_in_service_order_staff_row=$global->db_qry_data("SELECT GROUP_CONCAT(service_order.service_order_id),staff.staff_code,staff.staff_name,category.category_code,
SUM(service_orderdetails_quantity) AS quantity,
SUM(service_orderdetails_total) AS price
FROM service_order
