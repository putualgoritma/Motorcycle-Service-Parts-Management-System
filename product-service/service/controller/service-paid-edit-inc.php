...
$service_order_id=0;
Header("location: service-paid.php");
exit;
}
...
$service_order_check_d=$service_order_row['service_order_check_d'];
$service_order_check_h=$service_order_row['service_order_check_h'];
$service_order_check_m=$service_order_row['service_order_check_m'];
...
//insert service_order
	...
	foreach($_POST['product_scode_hidden'] as $key => $product_scode_hidden_val ) {
		...
		'product_orderdetails_status'=>	$service_orderdetails_status,
	...
	//redirect
	Header("location: service-paid.php?confirm=".$form_header_lang['edit_button']."&service_order_status=".$service_order_status."&service_order_id=".$service_order_id);
	exit;
}}
?>
