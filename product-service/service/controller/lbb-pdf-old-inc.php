...
$service_in_service_order_row=$global->db_qry_data("SELECT service_order.service_order_id,motorcycle_type.motorcycle_type_code,motorcycle_type.motorcycle_type_name,category.category_code,
...
$product_in_service_order_row=$global->db_qry_data("SELECT service_order.service_order_id,category.category_name,
...
//qry product in service_order group by category
$product_in_product_order_row=$global->db_qry_data("SELECT product_order.product_order_id,category.category_name,
SUM(product_orderdetails_total) AS price
FROM product_order
...
$servicetot_in_service_order_row=$global->db_qry_data("SELECT service_order.service_order_id,category.category_code,
SUM(service_orderdetails_total) AS price
FROM service_order
LEFT JOIN service_orderdetails ON service_order.service_order_id = service_orderdetails.service_order_id
LEFT JOIN service ON service_orderdetails.service_code = service.service_code
