            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="service-paid.php"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['service_order_sale']; ?></a></li>
                ...
                <section class="content">
                    <div class="row"><form action="service-paid-edit.php" method="post" enctype="multipart/form-data" name="form" id="form">
                        <div class="col-xs-12">
...
<div class="col-md-8 typehead_customer"><input name="users_code" type="text" class="textbox" id="users_code" required="required" rel="users_name" value="<? echo $users_code; ?>" placeholder="Ketik Kode/Nama">&nbsp;<a href="javascript:;" id="customer_view_alink"> <i class="fa fa-edit fa-lg"></i> </a></div>
</div>
...
<div class="row clearfix append_div_area">                                
  <div class="col-md-4"><strong><? echo $global->users->users_lang['form_label_users_lang']['area_name']; ?>:</strong></div>
<div class="col-md-8 typehead_area"><input name="area2_code" type="text" class="textbox" id="area2_code" required="required"></div>
</div>
...
<div class="row clearfix">                                
  <div class="col-md-4"><strong><? echo $global->users->users_lang['form_label_users_lang']['religion_name']; ?>:</strong></div>
<div class="col-md-8 typehead_religion"><input name="religion2_code" type="text" class="textbox" id="religion2_code"></div>
</div>
<div class="row clearfix">
<div class="col-md-4"><strong><? echo $global->users->users_lang['form_label_users_lang']['village_name']; ?>:</strong></div>
...
<div class="col-md-8 typehead_staff_mk"><a name="anc_staff_code" id="anc_staff_code"></a>
  <input name="staff_code" type="text" class="textbox<? if($btn_status=="btn_proc"){?> firstin<? }?>" id="staff_code" value="<? echo $staff_code; ?>"<? if($btn_status!=""){?> required="required"<? }?>></div>
</div>
...
<div class="col-md-8 typehead_staff_mk">
...
<div class="col-md-10"><input type="text" id="date_payregister" name="date_payregister" value="<? echo $service_order_row['service_order_payregister']; ?>" class="nxt_tab datepicker" required="required"></div>
</div>
  <div class="row clearfix">
