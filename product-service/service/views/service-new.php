...
<div class="row clearfix">
<div class="col-md-4"><strong>Group Customer:</strong></div>
<div class="col-md-8 typehead_village"><select name="users_group_code" class="textbox" id="users_group_code">
    <?php
...
<div class="col-md-8">
  <select name="service_order_express" id="service_order_express">
    ...
    <option<? if($list_inc==0){?> selected="selected"<? }?> value="<? echo $form_selectlist_lang['service_order_express'][$list_inc][0]; ?>"><? echo $form_selectlist_lang['service_order_express'][$list_inc][1]; ?></option>
    <? }?>
  </select>
</div>
</div>
...
<div class="col-md-8"><textarea name="service_order_memo" cols="30" rows="7" class="textbox" id="service_order_memo"></textarea>  
</div>
</div>
