...
<? include ("controller/service-paid-inc.php"); ?>
<? include ($path."templates/default/top-frame.php"); ?>
<? include ($path."templates/default/separator.php"); ?>
<?
if(isset($_REQUEST['service_order_status']) && $_REQUEST['service_order_status']=="tmp"){
$service_order_id_pop=$_REQUEST['service_order_id'];
?>
<script type="text/javascript">
$(document).ready(function() {
    var url="pdf/service-pkb-pdf.php?service_order_id=<? echo $service_order_id_pop ;?>";
...
?>
<? include ("views/service-paid.php"); ?>
