            ...
            <section data-spy="affix" data-offset-top="50" class="total content">
                ...
                <section class="content-header">
                    <h1>
                        <? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_minus']; ?>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="<? echo $path; ?>index.php"><i class="fa fa-home"></i> Home</a></li>
                        <li><a href="<? echo $path; ?>index-sub.php?module_code=<? echo $parent_active; ?>"> Penjualan</a></li>
                        <li><a href="product-sale.php"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_sale']; ?></a></li>
                        <li class="active"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_minus']; ?></li>
                    </ol>
                </section>

                <!-- Main content -->
                <section class="content">
                    <div class="row"><form action="product-sale-pay.php" method="post" enctype="multipart/form-data" name="form" id="form">
                        <div class="col-xs-12">
...
<div class="col-md-10"><input readonly="readonly" name="product_order_total_cash" type="text" class="textbox" id="product_order_total_cash" placeholder="0" value="<? echo $product_order_amount_format; ?>">
  &nbsp;&nbsp;Rekening:&nbsp; 
    <select name="product_order_accountpay_cash" class="textbox" id="product_order_accountpay_cash">
              <?
			$global->product_order->book->account_parent_special_create(array("cash_bank"),$product_order_row['product_order_accountdebit']);
			?>
              </select>
</div>
</div>
