            ...
            <section data-spy="affix" data-offset-top="50" class="total content">
                ...
                <section class="content">
                    <div class="row"><form action="product-sale-edit.php" method="post" enctype="multipart/form-data" name="form" id="form">
                        <div class="col-xs-12">
...
<div class="box box-danger">
            ...
            <div>&nbsp;</div>
                                <div class="row clearfix">
<div class="col-md-12 text-center"><button name="Submit" class="btn btn-info" id="Submit"><? echo $form_header_lang['save_button']; ?></button>&nbsp;<a class="btn btn-warning" onclick="javascript:location.href='product-sale-edit.php?Submitcancell=true'" id="Submitcancell"><? echo $form_header_lang['cancell_button']; ?>  (F6)</a></div>
</div>
<div>&nbsp;</div>
