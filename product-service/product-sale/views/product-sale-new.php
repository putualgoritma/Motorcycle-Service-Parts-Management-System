            ...
            <section data-spy="affix" data-offset-top="50" class="total content">
                ...
                <section class="content">
                    <div class="row"><form action="product-sale-new.php" method="post" enctype="multipart/form-data" name="form" id="form">
                        <div class="col-xs-12">
...
<div class="col-md-10"><input readonly="readonly" name="product_order_total_cash" type="text" class="textbox" id="product_order_total_cash" placeholder="0">
  &nbsp;&nbsp;Rekening:&nbsp; 
    <select name="product_order_accountpay_cash" class="textbox" id="product_order_accountpay_cash">
              <?
			$global->product_order->book->account_parent_special_create(array("cash_bank"),0);
			?>
              </select>
</div>
</div>
