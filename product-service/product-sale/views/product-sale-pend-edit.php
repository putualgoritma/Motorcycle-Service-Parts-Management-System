...
<div class="col-md-10"><input name="product_order_deposit" type="text" class="textbox" id="product_order_deposit" placeholder="0" value="<? echo $product_order_row['product_order_deposit']; ?>">
  &nbsp;&nbsp;Rekening:&nbsp; 
    <select name="product_order_deposit_debit_acc" class="textbox" id="product_order_deposit_debit_acc">
              <?
			$global->product_order->book->account_special_create(array("cash"),$product_order_accountdebit);
			?>
              </select>
</div>
</div>
...
<div class="box box-danger">
            ...
            <div>&nbsp;</div>
                                <div class="row clearfix">
<div class="col-md-12 text-center"><button name="Submit" class="btn btn-primary" id="Submit"><? echo $form_header_lang['process_button']; ?>  (F5)</button>&nbsp;<a class="btn btn-warning" onclick="javascript:location.href='product-sale-pend-edit.php?Submitcancell=true'" id="Submitcancell"><? echo $form_header_lang['cancell_button']; ?>  (F6)</a></div>
</div>
<div>&nbsp;</div>
