            ...
            <section data-spy="affix" data-offset-top="50" class="total content">
                    <div class="col-md-12"><strong>Total: Rp <span class="amount_total"><? echo $product_order_amount_format; ?></span></strong></div>
            </section>
                           
                <!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        <? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_sale_retur_edit']; ?>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="<? echo $path; ?>index.php"><i class="fa fa-home"></i> Home</a></li>
                        <li><a href="<? echo $path; ?>index-sub.php?module_code=<? echo $parent_active; ?>"> Penjualan</a></li>
                        <li><a href="product-sale-retur.php"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_sale_retur']; ?></a></li>
                        <li class="active"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_sale_retur_edit']; ?></li>
                    </ol>
                </section>

                <!-- Main content -->
                <section class="content">
                    <div class="row"><form action="product-sale-retur-pay.php" method="post" enctype="multipart/form-data" name="form" id="form">
                        <div class="col-xs-12">
  ...
  <p class="title-header"><strong><u><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_sale_retur_edit']; ?></u></strong></p>                     
<div class="row clearfix">
<div class="col-md-2"><strong><? echo $form_header_lang['date_input']; ?>:</strong></div>
<div class="col-md-10"><input name="product_order_id" type="hidden" id="product_order_id" value="<? echo $product_order_row['product_order_id']; ?>" /><input type="text" id="datepicker" name="date_register" value="<? echo $product_order_row['product_order_register']; ?>" class="nxt_tab" required="required"></div>
</div>
<div class="row clearfix<? if($product_order_row['ht_order_id']>0){?> td_hide<? }?>">
...
<div class="col-md-10 typehead_customer"><input name="users_code" type="text" class="textbox firstin" id="users_code" value="<? echo $product_order_row['users_code']; ?> - <? echo $product_order_row['users_name']; ?>" required="required" rel="product_order_code"></div>
</div>
...
<thead>
  ...
  <td><a href="#" class="link_table product_order_sale_edit"><div class="product_scode"><? echo $product_scode; ?></div><input name="product_scode_hidden[]" type="hidden" value="<? echo $product_scode; ?>"/></a></td>
...
<div class="col-md-8"><input readonly="readonly" name="product_order_tax" type="text" class="textbox" id="product_order_tax" value="<? echo $product_order_tax_val_format; ?>">
  ...
  <div class="row clearfix"<? if($product_order_deposit<1){?> style="display:none"<? }?>>
  <div class="col-md-4"><strong><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_sale_deposit']; ?>:</strong></div>
<div class="col-md-8"><input name="product_order_sale_deposit" type="text" class="textbox product_order_sale_deposit" id="product_order_sale_deposit" value="<? echo $product_order_deposit; ?>">
</div>
</div>
...
<div class="col-md-8"><input name="product_order_cost" type="text" class="textbox product_order_sale_total masknumber" id="product_order_cost" value="<? echo $product_order_row['product_order_cost']; ?>">
</div>
</div>
...
<div class="box box-info">
  ...
  <p class="title-header"><strong><u><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_sale_pay_tran']; ?></u></strong></p>                     

<div class="row clearfix">
  <div class="col-md-12">
  <div class="row clearfix">
<div class="col-md-2"><strong><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_sale_pay_tran']; ?>:</strong></div>
<div class="col-md-10">
    <label>
      <input name="product_order_sale_pay" type="radio" id="product_order_sale_pay1_0" value="cash"<? if($product_order_row['product_order_pay_method']=="cash"){ ?> checked="checked"<? }?> />
      Tunai</label>
     <label>
      <input type="radio" name="product_order_sale_pay" value="credit" id="product_order_sale_pay1_2"<? if($product_order_row['product_order_pay_method']=="credit"){ ?> checked="checked"<? }?> />
      Kredit</label>
</div>
</div>
<div class="row clearfix" id="product_order_sale_pay_cash"<? if($product_order_row['product_order_pay_method']!="cash"){ ?> style="display:none"<? }?>>
...
<div class="col-md-10"><input readonly="readonly" name="product_order_total_cash" type="text" class="textbox" id="product_order_total_cash" placeholder="0" value="<? echo $product_order_amount_format; ?>">
  &nbsp;&nbsp;Rekening:&nbsp; 
    <select name="product_order_accountpay_cash" class="textbox" id="product_order_accountpay_cash">
              <?
			$global->product_order->book->account_special_create(array("cash"),$product_order_row['product_order_accountdebit']);
			?>
              </select>
</div>
</div>

<div class="row clearfix" id="product_order_sale_pay_bank"<? if($product_order_row['product_order_pay_method']!="bank"){ ?> style="display:none"<? }?>>
...
<div class="col-md-10"><input readonly="readonly" name="product_order_total_bank" type="text" class="textbox" id="product_order_total_bank" placeholder="0" value="<? echo $product_order_amount_format; ?>">
  ...
  &nbsp;&nbsp;Rekening:&nbsp;
    <select name="product_order_accountpay_bank" class="textbox" id="product_order_accountpay_bank">
              <?
			$global->product_order->book->account_special_create(array("bank"),$product_order_row['product_order_accountdebit']);
			?>
              </select>
</div>
</div>

<div class="row clearfix" id="product_order_sale_pay_credit"<? if($product_order_row['product_order_pay_method']!="credit"){ ?> style="display:none"<? }?>>
...
<div class="col-md-10"><input readonly="readonly" name="product_order_total_credit" type="text" class="textbox" id="product_order_total_credit" placeholder="0" value="<? echo $product_order_amount_format; ?>">
  &nbsp;&nbsp;Rekening:&nbsp; 
    <select name="product_order_accountpay_credit" class="textbox" id="product_order_accountpay_credit">
              <?
			$global->product_order->book->account_special_create(array("trade"),$product_order_row['product_order_accountdebit']);
			?>
              </select>
</div>
</div>
...
<div class="box box-danger">
            ...
            <div>&nbsp;</div>
                                <div class="row clearfix">
<div class="col-md-12 text-center"><a class="btn btn-primary calc_modal" id="Submitpay"<? if($product_order_row['product_order_pay_method']!="cash"){ ?> style="display:none"<? }?>><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['calculator']; ?>  (F7)</a><button name="Submit" class="btn btn-primary" id="Submit"<? if($product_order_row['product_order_pay_method']=="cash"){ ?> style="display:none"<? }?>><? echo $form_header_lang['process_button']; ?>  (F5)</button>&nbsp;<a class="btn btn-warning" onclick="javascript:location.href='product-sale-retur-pay.php?Submitcancell=true'" id="Submitcancell"><? echo $form_header_lang['cancell_button']; ?>  (F6)</a></div>
</div>
<div>&nbsp;</div>
...
<div class="col-md-8"><input name="product_code" type="text" class="textbox" id="product_scode" required="required" rel="product_orderdetails_quantity" disabled="disabled">
...
<div class="col-md-8">
              <input name="product_orderdetails_price" type="text" class="textbox firstin masknumber" id="product_orderdetails_price" value="" required="required">
</div>
</div>
<div class="row clearfix">                                
