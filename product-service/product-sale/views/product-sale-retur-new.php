            ...
            <section data-spy="affix" data-offset-top="50" class="total content">
                    <div class="col-md-12"><strong>Total: Rp <span class="amount_total">0.00</span></strong></div>
            </section>
                           
                <!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        <? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_sale_retur_new']; ?>
                    </h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_sale_retur_new']; ?></li>
                    </ol>
                </section>

                <!-- Main content -->
                <section class="content">
                    <div class="row"><form action="product-sale-retur-new.php" method="post" enctype="multipart/form-data" name="form" id="form">
                        <div class="col-xs-12">
  ...
  <p class="title-header"><strong><u><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_sale_retur_new']; ?></u></strong></p>                     
...
<div class="row clearfix<? if(!isset($_REQUEST['po_code'])){?> td_hide<? }?>">
<div class="col-md-2"><strong><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_sale_pend']; ?>:</strong></div>
<div class="col-md-10 typehead_ho"><input name="po_code" type="text" class="textbox" id="po_code">&nbsp;<a href="javascript:;" id="HT_Reload"> <i class="fa fa-download fa-lg" aria-hidden="true"></i>
 </a></div>
</div>
<div class="row clearfix">
...
<div class="col-md-10 typehead_customer"><input name="users_code" type="text" class="textbox<? if(!isset($_REQUEST['po_code'])){?> firstin<? }?>" id="users_code" required="required" rel="product_order_code"></div>
</div>
<div class="row clearfix">
...
<div class="col-md-8"><input name="product_order_cost" type="text" class="textbox product_order_sale_total masknumber" id="product_order_cost" value="0">
  ...
  <div class="row clearfix"<? if(!isset($_REQUEST['po_code'])){?> style="display:none"<? }?>>
...
<div class="col-md-10">
    <label>
      <input name="product_order_sale_pay" type="radio" id="product_order_sale_pay1_0" value="cash" checked="checked" />
      Tunai</label>
     <label>
      <input type="radio" name="product_order_sale_pay" value="credit" id="product_order_sale_pay1_2" />
      Kredit</label>
</div>
</div>
<div class="row clearfix" id="product_order_sale_pay_cash">
...
<div class="row clearfix" id="product_order_sale_pay_bank" style="display:none">
...
<div class="row clearfix" id="product_order_sale_pay_credit" style="display:none">
...
<div class="box box-danger">
            ...
            <div>&nbsp;</div>
                                <div class="row clearfix">
<div class="col-md-12 text-center"><button name="Save" class="btn btn-info" id="Save"><? echo $form_header_lang['save_button']; ?></button>&nbsp;<a class="btn btn-primary calc_modal" id="Submitpay"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['calculator']; ?>  (F7)</a><button name="Submit" class="btn btn-primary" id="Submit" style="display:none"><? echo $form_header_lang['process_button']; ?>  (F5)</button>&nbsp;<a class="btn btn-warning" onclick="javascript:location.href='product-sale-retur-new.php?Submitcancell=true'" id="Submitcancell"><? echo $form_header_lang['cancell_button']; ?>  (F6)</a></div>
</div>
<div>&nbsp;</div>
...
<div class="box-body table-responsive">
<form action="#" method="post" enctype="multipart/form-data" name="form" id="form_product_order"><input name="product_order_id" type="hidden" id="product_order_id" value="0" /><input name="inner_id_hidden" type="hidden" id="inner_id_hidden" value="" />
...
<div class="col-md-8"><input name="product_scode" type="text" class="textbox" id="product_scode" required="required" rel="product_orderdetails_quantity" disabled="disabled">
