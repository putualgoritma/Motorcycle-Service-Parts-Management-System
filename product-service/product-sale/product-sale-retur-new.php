...
<? $parent_active="product-service/product-sale"; ?>
<? $page_active="product-service/product-sale/product-sale-retur"; ?>
<? include ($path."controller/login-sessi.php"); ?>
<? include ("controller/product-sale-retur-new-inc.php"); ?>
<? include ($path."templates/default/top-frame.php"); ?>
<? include ($path."templates/default/separator.php"); ?>
<? include ("views/product-sale-retur-new.php"); ?>
...
$(document).ready(function() {
	$('.typehead_ho #po_code').typeahead('val', '<? echo $po_code;?>');
	$("#HT_Reload").trigger("click");
});
</script>
<?
}
