...
'sort'=>$sort_value,
'join_match'=>$date_range_match." AND product_order.product_order_type='ht'".$users_code_match." GROUP BY product_order.product_order_id",
'join_id'=>"",
...
'join_tbl_id'=>array("","(product_orderdetails.product_orderdetails_status = 'pmn' OR product_orderdetails.product_orderdetails_status = 'tmp')"),
);
