...
Header("location: product-sale-receivable.php?search=$search&sort=$sort&per_page=$per_page");
exit;
}
//paid
...
'sort'=>$sort_value,
'join_match'=>$date_range_match." AND product_order.product_order_type='si' AND product_order.product_order_status = 'pmn' AND product_order.product_order_pay_method = 'credit'".$users_code_match." GROUP BY product_order.product_order_id",
'join_id'=>"",
...
'join_tbl_field'=>array("payreceivable_id,payreceivable_paid_status","users_code,users_name","product_order_id,(SUM(product_orderdetails_total)) AS product_orderdetails_price_total","payreceivable_id,IFNULL(SUM(payreceivable_details_amount), '0') AS payreceivable_details_amount_total"),
