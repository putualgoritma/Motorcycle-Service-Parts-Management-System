...
<? include ("../controller/sales-ht-pdf-inc.php"); ?>
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
  <tr>
    <td align=\"right\"><h3> HOTLINE ORDER</h3></td>
  </tr>
</table>
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"3\" class=\"garis garis2\">
  ...
  ";
	...
	$product_order_deposit=$product_order_row['product_order_deposit'];
	$grand_total=$gross_total-$product_order_deposit-$disc_total;
	$html .= "
</table>
...
<div class=\"col-md-4\"><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
  ...
  <tr>
    <td>Deposit</td>
    <td>:</td>
    <td align=\"right\">".$global->num_format2($product_order_deposit)."</td>
  </tr>
  <tr>
    <td>Sisa</td>
    <td>:</td>
