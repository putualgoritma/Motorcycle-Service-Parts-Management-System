...
<? include ("../controller/buy-po-pdf-inc.php"); ?>
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
  <tr>
    <td align=\"right\"><h3> FAKTUR PEMBELIAN</h3></td>
  </tr>
</table>
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
  <tr>
    <td width=\"6%\">Kepada</td>
    <td width=\"39%\">: ".$users_row['users_name']."</td>
    <td width=\"20%\">&nbsp;</td>
    <td width=\"10%\">&nbsp;</td>
    <td width=\"25%\">&nbsp;</td>
  </tr>
...
<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"3\" class=\"garis garis2\">
  ";
      ...
      $product_orderdetails_disc_val = ($product_orderdetails_row['select_data'][$i]['product_orderdetails_discount']/100)*$product_orderdetails_row['select_data'][$i]['product_orderdetails_price'];
  ...
  <tr>
    ...
    <td width=\"15%\">".$product_orderdetails_row['select_data'][$i]['product_name']."</td>
    ...
    <td width=\"15%\" align=\"right\">".$product_orderdetails_row['select_data'][$i]['product_orderdetails_discount']."</td>
    <td width=\"15%\" align=\"right\">".$global->num_format2($product_orderdetails_disc_val)."</td>
