            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <h1><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_buy']; ?></h1>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_buy']; ?></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-danger">
                                ...
                                <form action="product-buy.php" method="post" enctype="multipart/form-data" name="formsearch" id="formsearch">
...
<? if($ulm_arr[$parent_active][$page_active]['users_level_module_access_add']==1){?><button class="btn btn-info"  onclick="location.href='product-buy-new.php'" type="button" id="btn_new"><i class="fa fa-plus"></i> <? echo $form_header_lang['add_new_kop']; ?> (F3)</button><? }?>

&nbsp;<? if($ulm_arr[$parent_active][$page_active]['users_level_module_access_delete']==1){?><button class="btn btn-danger" onclick="setCount(0,document.delform,'product-buy.php?delete=true&amp;search=<? echo$search_value; ?>&amp;sort=<? echo"$sort_value"; ?>')" name="Submitdel" value="view" id="Submitdel"><i class="fa fa-times"></i> Hapus (F4)</button><? }?>
...
<div class="clear">&nbsp;</div>
                                    ...
                                    <table width="100%" class="table table-bordered table-hover table-fixed gridView" id="example1">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" width="15%"><strong><a href="product-buy.php?search=<? echo $search_value; ?>&amp;sort=product_order.product_order_registernum <? if($sort_value=="product_order.product_order_registernum ASC"){?>DESC<? }else{?>ASC<? }?>" class="link_table_title"><? if($sort_value=="product_order.product_order_registernum ASC"){?><i class="fa fa-sort-alpha-asc"></i><? }else{?><i class="fa fa-sort-alpha-desc"></i><? }?>&nbsp;&nbsp;<? echo $global->product_order->product_order_lang['form_label_product_order_lang']['product_order_register']; ?></a></strong></td>
                                                <td width="11%" align="center"><strong><a href="product-buy.php?search=<? echo $search_value; ?>&amp;sort=product_order.product_order_status <? if($sort_value=="product_order.product_order_status ASC"){?>DESC<? }else{?>ASC<? }?>" class="link_table_title">
  ...
  &nbsp;&nbsp;<? echo $global->product_order->product_order_lang['form_label_product_order_lang']['product_order_status']; ?></a></strong></td>
				...
				$view_link="product_order_buy_edit_modal_off";
				if($ulm_arr[$parent_active][$page_active]['users_level_module_access_edit']==1){
				$view_link="product_order_buy_edit_modal";
				}
			...
			?>
                                        ...
                                        <tr>
                                            ...
                                            <td bgcolor="<? echo"$bg_color"; ?>"><a href="javascript:;" class="link_table <? echo $view_link; ?>"><? if($product_order_search_list[$i]['product_order_type']=='pi'){ echo $site_lang['currency'].$global->num_format($product_order_search_list[$i]['product_orderdetails_price_total']); }else{echo "-";} ?></a></td>
                  ...
                  <table width="360" border="0" align="center" cellpadding="0" cellspacing="0" id="nexprev">
                      ...
                      <tr>
                        ...
                        <td align="right"><? if($current_page>1) { ?>
                            ...
                            <a href="product-buy.php?search=<? echo"$search_value"; ?>&amp;year=<? echo"$year_value"; ?>&amp;month=<? echo"$month_value"; ?>&amp;date=<? echo $date_value; ?>&amp;per_page=<? echo $per_page_value; ?>&amp;project_id=<? echo $project_id_value; ?>&amp;sort=<? echo"$sort_value"; ?>&amp;pageset=0"><i class="fa fa-angle-double-left"></i></a> <a href="product-buy.php?search=<? echo"$search_value"; ?>&amp;year=<? echo"$year_value"; ?>&amp;month=<? echo"$month_value"; ?>&amp;date=<? echo $date_value; ?>&amp;per_page=<? echo $per_page_value; ?>&amp;project_id=<? echo $project_id_value; ?>&amp;sort=<? echo"$sort_value"; ?>&amp;pageset=<? echo"$pageset_prev"; ?>"><i class="fa fa-angle-left"></i></a>
                        ...
                        <td><? if($current_page<$total_page) { ?>
                            ...
                            <a href="product-buy.php?search=<? echo"$search_value"; ?>&amp;year=<? echo"$year_value"; ?>&amp;month=<? echo"$month_value"; ?>&amp;date=<? echo $date_value; ?>&amp;per_page=<? echo $per_page_value; ?>&amp;project_id=<? echo $project_id_value; ?>&amp;sort=<? echo"$sort_value"; ?>&amp;pageset=<? echo"$pageset_next"; ?>"><i class="fa fa-angle-right"></i></a> <a href="product-buy.php?search=<? echo"$search_value"; ?>&amp;year=<? echo"$year_value"; ?>&amp;month=<? echo"$month_value"; ?>&amp;date=<? echo $date_value; ?>&amp;per_page=<? echo $per_page_value; ?>&amp;project_id=<? echo $project_id_value; ?>&amp;sort=<? echo"$sort_value"; ?>&amp;pageset=<? echo"$pageset_last"; ?>"><i class="fa fa-angle-double-right"></i></a>
