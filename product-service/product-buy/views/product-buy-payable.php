            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <h1><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_payable']; ?></h1>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_payable']; ?></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box box-danger">
                                ...
                                <form action="product-buy-payable.php" method="post" enctype="multipart/form-data" name="formsearch" id="formsearch">
...
<div class="clear">&nbsp;</div>
                                    ...
                                    <form method="post" id="paidform" name="paidform" enctype="multipart/form-data" action=""><? if($ulm_arr[$parent_active][$page_active]['users_level_module_access_add']==1){?><button class="btn btn-info" onclick="setCount(0,document.paidform,'product-buy-payable.php?paid=true&amp;search=<? echo$search_value; ?>&amp;sort=<? echo"$sort_value"; ?>')" name="Submitpaid" value="view" id="btn_new"><i class="fa fa-times"></i> Bayar (F3)</button><? }?><table width="100%" class="table table-bordered table-hover table-fixed gridView" id="example1">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td width="13%" align="center"><strong><? echo $global->payreceivable->payreceivable_lang['form_label_payreceivable_lang']['payreceivable_balance']; ?></strong></td>
                                            </tr>
			...
			?>
                                        ...
                                        <tr>
                                            ...
                                            <td bgcolor="<? echo"$bg_color"; ?>"><? if($product_order_search_list[$i]['product_order_type']=='pi'){ echo $site_lang['currency'].$global->num_format($product_order_search_list[$i]['product_orderdetails_price_total']); }else{echo "-";} ?></td>
                  ...
                  <table width="360" border="0" align="center" cellpadding="0" cellspacing="0" id="nexprev">
                      ...
                      <tr>
                        ...
                        <td align="right"><? if($current_page>1) { ?>
                            ...
                            <a href="product-buy-payable.php?search=<? echo"$search_value"; ?>&amp;year=<? echo"$year_value"; ?>&amp;month=<? echo"$month_value"; ?>&amp;date=<? echo $date_value; ?>&amp;per_page=<? echo $per_page_value; ?>&amp;project_id=<? echo $project_id_value; ?>&amp;sort=<? echo"$sort_value"; ?>&amp;pageset=0"><i class="fa fa-angle-double-left"></i></a> <a href="product-buy-payable.php?search=<? echo"$search_value"; ?>&amp;year=<? echo"$year_value"; ?>&amp;month=<? echo"$month_value"; ?>&amp;date=<? echo $date_value; ?>&amp;per_page=<? echo $per_page_value; ?>&amp;project_id=<? echo $project_id_value; ?>&amp;sort=<? echo"$sort_value"; ?>&amp;pageset=<? echo"$pageset_prev"; ?>"><i class="fa fa-angle-left"></i></a>
                        ...
                        <td><? if($current_page<$total_page) { ?>
                            ...
                            <a href="product-buy-payable.php?search=<? echo"$search_value"; ?>&amp;year=<? echo"$year_value"; ?>&amp;month=<? echo"$month_value"; ?>&amp;date=<? echo $date_value; ?>&amp;per_page=<? echo $per_page_value; ?>&amp;project_id=<? echo $project_id_value; ?>&amp;sort=<? echo"$sort_value"; ?>&amp;pageset=<? echo"$pageset_next"; ?>"><i class="fa fa-angle-right"></i></a> <a href="product-buy-payable.php?search=<? echo"$search_value"; ?>&amp;year=<? echo"$year_value"; ?>&amp;month=<? echo"$month_value"; ?>&amp;date=<? echo $date_value; ?>&amp;per_page=<? echo $per_page_value; ?>&amp;project_id=<? echo $project_id_value; ?>&amp;sort=<? echo"$sort_value"; ?>&amp;pageset=<? echo"$pageset_last"; ?>"><i class="fa fa-angle-double-right"></i></a>
