            ...
            <aside class="right-side">                
                ...
                <section class="content">
                    ...
                    <div class="row"><form action="product-buy-new.php" method="post" enctype="multipart/form-data" name="form" id="form">
...
<div class="clear">&nbsp;</div>
                            ...
                            <div class="box box-danger">
                                ...
                                <button name="Stock_Min" class="btn btn-info" id="Stock_Min"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['stock_min']; ?></button>
...
<div class="col-md-10"><input type="text" id="product_order_due_register" name="product_order_due_register" value="<? echo $date_def; ?>" class="nxt_tab datepicker"></div>
