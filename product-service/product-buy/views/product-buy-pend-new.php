            ...
            <aside class="right-side">                
                ...
                <section class="content">
                    ...
                    <div class="row"><form action="product-buy-pend-new.php" method="post" enctype="multipart/form-data" name="form" id="form">
...
<thead>
  ...
  <tr>
    ...
    <input name="product_bcode" type="text" class="textbox" id="product_bcode" rel="product_orderdetails_price" />&nbsp;<a href="javascript:;" id="product_view_alink"> <i class="fa fa-edit fa-lg"></i> </a>
...
<div class="col-md-12 text-center"><button name="Submit" class="btn btn-primary" id="Submit"><? echo $form_header_lang['process_button']; ?>  (F5)</button>&nbsp;<a class="btn btn-warning" onclick="javascript:location.href='product-buy-pend-new.php?Submitcancell=true'" id="Submitcancell"><? echo $form_header_lang['cancell_button']; ?>  (F6)</a></div>
...
<div class="col-md-8"><input name="product_code" type="text" class="textbox" id="product_bcode" disabled="disabled">
...
<div class="col-md-8">
              ...
              <input name="product_orderdetails_price" type="text" class="textbox firstin masknumber" id="product_orderdetails_price" value=""></div>
