            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <h1>
                        ...
                        <? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_plus']; ?>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="product-buy.php"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_buy']; ?></a></li>

                        <li class="active"><? echo $global->product_order->product_order_lang['form_header_product_order_lang']['product_order_plus']; ?></li>
                ...
                <section class="content">
                    ...
                    <div class="row"><form action="product-buy-edit.php" method="post" enctype="multipart/form-data" name="form" id="form">
...
<div class="col-md-10"><input name="product_order_code" type="text" class="textbox" id="product_order_code" value="<? echo $product_order_row['product_order_code']; ?>"></div>
...
<div class="col-md-10"><input readonly="readonly" name="product_order_total_cash" type="text" class="textbox" id="product_order_total_cash" placeholder="0" value="<? echo $product_order_amount_format; ?>">
  ...
  &nbsp;&nbsp;Rekening:&nbsp; 
    ...
    <select name="product_order_accountpay_cash" class="textbox" id="product_order_accountpay_cash">
			...
			$global->product_order->book->account_parent_special_create(array("cash_bank"),$product_order_row['product_order_accountcredit']);
...
<div class="col-md-10"><input readonly="readonly" name="product_order_total_credit" type="text" class="textbox" id="product_order_total_credit" placeholder="0" value="<? echo $product_order_amount_format; ?>">
  ...
  &nbsp;&nbsp;Rekening:&nbsp; 
    ...
    <select name="product_order_accountpay_credit" class="textbox" id="product_order_accountpay_credit">
			...
			$global->product_order->book->account_special_create(array("trade_payable"),$product_order_row['product_order_accountcredit']);
...
<div class="col-md-2"><strong><? echo $global->product_order->product_order_lang['form_label_product_order_lang']['product_order_due_register']; ?>:</strong></div>

<div class="col-md-10"><input type="text" id="product_order_due_register" name="product_order_due_register" value="<? echo $product_order_row['product_order_due_register']; ?>" class="nxt_tab datepicker"></div>
...
<div class="col-md-12 text-center"><button name="Submit" class="btn btn-primary" id="Submit"><? echo $form_header_lang['process_button']; ?>  (F5)</button>&nbsp;<a class="btn btn-warning" onclick="javascript:location.href='product-buy-edit.php?Submitcancell=true'" id="Submitcancell"><? echo $form_header_lang['cancell_button']; ?>  (F6)</a></div>
